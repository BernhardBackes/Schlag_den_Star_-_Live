...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SelectAnswerScore {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        public UserControlGame() {
            ...
            this.comboBoxLeftPlayerInput.Items.AddRange(Enum.GetNames(typeof(VentuzScenes.GamePool.SelectAnswerScore.Host.PlayerSelections)));
            this.comboBoxLeftPlayerInput.EndUpdate();

            this.comboBoxRightPlayerInput.BeginUpdate();
            this.comboBoxRightPlayerInput.Items.AddRange(Enum.GetNames(typeof(VentuzScenes.GamePool.SelectAnswerScore.Host.PlayerSelections)));
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, this.playAudio);
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVfullscreen_StartAudio);
            this.stepList.Add(step);
        ...
        protected int playAudio(
            int stepIndex) {
            if (this.buttonVfullscreen_StartAudio.Enabled) return stepIndex + 1;
        ...
        private void selectDataset(
            ...
            if (this.selectedDataset is DatasetContent) {
                ...
                this.buttonVfullscreen_StartAudio.Enabled = this.selectedDataset.ValidAudio;
            }
            else {
                this.pictureBoxDatasetPicture.Enabled = false;
                this.pictureBoxDatasetPicture.Image = null;
                this.buttonVfullscreen_StartAudio.Enabled = false;
            }

            Helper.setControlBackColor(this.buttonVfullscreen_StartAudio);
        ...
        private void comboBoxLeftPlayerInput_SelectedIndexChanged(object sender, EventArgs e) {
            VentuzScenes.GamePool.SelectAnswerScore.Host.PlayerSelections result;
        ...
        private void buttonVfullscreen_StartAudio_Click(object sender, EventArgs e) { this.business.Vfullscreen_StartAudio(); }
