...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.Select1PictureOf4 {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        private void setLabelDatasetSolution() {
            if (this.selectedDataset is DatasetContent) {
                this.labelDatasetSolution.Text = string.Format("solution: {0}", this.selectedDataset.SolutionID.ToString());
                this.labelDatasetSolution.Enabled = true;
                Helper.setControlBackColor(this.labelDatasetSolution);
            }
            else {
                this.labelDatasetSolution.Text = "solution: -";
                this.labelDatasetSolution.Enabled = false;
                Helper.setControlBackColor(this.labelDatasetSolution);
            }
        }
        ...
        void selectedDataset_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.selectedDataset_PropertyChanged(sender, e)));
                ...
                else if (e.PropertyName == "SolutionID") this.setLabelDatasetSolution();
            }
        }
