...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.InsertAndFullscreenStillBuzzerScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.InsertAndFullscreenStillBuzzerScore {
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.InsertAndFullscreenStillBuzzerScore'", typeIdentifier);
        }
        ...
        public void Vinsert_ContentIn() {
            if (this.insertScene is VRemote4.HandlerSi.Scene &&
                ...
                this.Vinsert_SetContent(this.insertScene, this.SelectedDataset.TaskFilename);
        ...
        public void Vinsert_SetContent(
            ...
            if (scene is Insert) {
                ...
                scene.SetFilename(taskFilename);
            }
        }
        public void Vinsert_ContentOut() { 
            if (this.insertScene is VRemote4.HandlerSi.Scene) this.insertScene.ToOut();
        ...
        public void Vfullscreen_ContentIn() {
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene &&
                this.SelectedDataset is DatasetContent) {
                this.Vfullscreen_SetContent(this.fullscreenScene, this.SelectedDataset.SolutionFilename, this.SelectedDataset.Name);
        ...
        public void Vfullscreen_SetContent(
            ...
            if (scene is Fullscreen) {
                scene.SetFilename(solutionFilename);
                scene.TextInsert.SetPositionX(0);
                scene.TextInsert.SetPositionY(0);
                scene.TextInsert.SetStyle(VentuzScenes.GamePool._Modules.TextInsert.Styles.OneRow);
        ...
        public void Vfullscreen_ContentOut() {
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene) {
                this.fullscreenScene.ToOut();
                this.fullscreenScene.TextInsert.ToOut();
            }
        }
        ...
        public void Vhost_ContentIn() {
            ...
            if (this.HostSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.hostScene is Host) this.hostScene.ToIn();
        }
        public void Vhost_SetContent() { if (this.hostScene is VRemote4.HandlerSi.Scene && this.SelectedDataset is DatasetContent) this.Vhost_SetContent(this.hostScene, this.TaskCounter, this.SelectedDataset.HostText, this.SelectedDataset.TaskFilename, this.SelectedDataset.SolutionFilename); }
        ...
        public void Vhost_ContentOut() {
            if (this.HostSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.hostScene is Host) this.hostScene.ToOut();
        }
        ...
        public void Vleftplayer_SetContent() { if (this.leftPlayerScene is VRemote4.HandlerSi.Scene && this.SelectedDataset is DatasetContent) this.Vplayer_Set(this.leftPlayerScene, this.SelectedDataset.TaskFilename); }
        ...
        public void Vrightplayer_SetContent() { if (this.rightPlayerScene is VRemote4.HandlerSi.Scene && this.SelectedDataset is DatasetContent) this.Vplayer_Set(this.rightPlayerScene, this.SelectedDataset.TaskFilename); }
        ...
        public void Vplayer_Set(
            ...
            string taskFilename) {
            if (scene is Player &&
                !string.IsNullOrEmpty(taskFilename)) scene.SetTaskFilename(taskFilename);
        }
