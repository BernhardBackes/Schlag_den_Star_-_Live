...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.PictureInsertAndFullscreenScore {
        ...
        public string PictureFilename {
            ...
            set {
                if (this.pictureFilename != value) {
                    ...
                    this.Picture = Helper.getThumbnailFromMediaFile(value, 1.0f);
                }
            }
        }
    ...
    public class Business : _Base.Score.Business {
        ...
        private decimal insertScaling = 100;
        public decimal InsertScaling {
            get { return this.insertScaling; }
            set {
                if (this.insertScaling != value) {
                    this.insertScaling = value;
                    this.on_PropertyChanged();
                    this.Vinsert_SetContent();
                }
            }
        ...
        private int fullscreenPositionX = 0;
        public int FullscreenPositionX {
            get { return this.fullscreenPositionX; }
            set {
                if (this.fullscreenPositionX != value) {
                    this.fullscreenPositionX = value;
                    this.on_PropertyChanged();
        ...
        private int fullscreenPositionY = 0;
        public int FullscreenPositionY {
            get { return this.fullscreenPositionY; }
            set {
                if (this.fullscreenPositionY != value) {
                    this.fullscreenPositionY = value;
                    this.on_PropertyChanged();
                    this.Vfullscreen_SetContent();
                }
            }
        ...
        private decimal fullscreenScaling = 100;
        public decimal FullscreenScaling {
            get { return this.fullscreenScaling; }
            set {
                if (this.fullscreenScaling != value) {
                    this.fullscreenScaling = value;
                    this.on_PropertyChanged();
                    this.Vfullscreen_SetContent();
                }
            }
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.PictureInsertAndFullscreenScore'", typeIdentifier);
        }
        ...
        public void Vinsert_SetContent() {
            if (this.insertScene is Insert &&
                this.SelectedDataset is DatasetContent) this.Vinsert_SetContent(this.insertScene.Game, this.SelectedDataset.PictureFilename);
        }
        public void Vinsert_SetContent(
            Game scene,
            string pictureFilename) {
            if (scene is Game) {
                ...
                scene.SetScaling(this.InsertScaling);
        ...
        public void Vfullscreen_SetContent() {
            if (this.SelectedDataset is DatasetContent) this.Vfullscreen_SetContent(this.fullscreenScene, this.SelectedDataset.PictureFilename);
        }
        public void Vfullscreen_SetContent(
            Fullscreen scene,
            string pictureFilename) {
            if (scene is Fullscreen) {
                scene.SetPositionX(this.FullscreenPositionX);
                scene.SetPositionY(this.FullscreenPositionY);
                scene.SetScaling(this.FullscreenScaling);
                scene.SetFilename(pictureFilename);
            }
        }
