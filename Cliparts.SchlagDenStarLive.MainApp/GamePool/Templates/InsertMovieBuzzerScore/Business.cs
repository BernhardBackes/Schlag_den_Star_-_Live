...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.InsertMovieBuzzerScore {
        ...
        public string MovieFilename {
            ...
            set {
                if (this.movieFilename != value) {
                    ...
                    this.Movie = Helper.getThumbnailFromMediaFile(value, 0.1f);
                }
            }
        }
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.InsertMovieBuzzerScore'", typeIdentifier);
        }
        ...
        public void Vinsert_ContentIn() {
            if (this.insertScene is VRemote4.HandlerSi.Scene &&
                ...
                this.Vinsert_SetContent(this.insertScene, this.SelectedDataset.MovieFilename);
