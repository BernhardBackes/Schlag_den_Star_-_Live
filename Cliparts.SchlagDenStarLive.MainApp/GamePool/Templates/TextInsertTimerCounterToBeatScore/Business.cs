...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TextInsertTimerCounterToBeatScore
{
    ...
    public class Business : _Base.TimerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TextInsertTimerCounterToBeatScore'", typeIdentifier);
        }
        ...
        public void True()
        {
            ...
            this.CounterValue++;
            this.CounterTime = this.insertScene.Timer.CurrentTime;
            this.Vinsert_SetCounter();
        }
        ...
        internal void Vfullscreen_SetContent()
        {
            ...
            else this.Vfullscreen_ContentOut();
        }
