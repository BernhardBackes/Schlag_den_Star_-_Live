...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.PictureTwoTimersScores;

namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.PictureTwoTimersScores {
    ...
    public class Business : _Base.TwoTimersScores.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.PictureTwoTimersScores'", typeIdentifier);
        }
        ...
        public void Vinsert_SetContent() {
            if (this.SelectedDataset is DatasetContent) this.Vinsert_SetContent(this.insertScene, this.SelectedDataset.PictureFilename);
        }
        public void Vinsert_SetContent(
            Insert scene,
            string pictureFilename) {
            if (scene is Insert) {
                ...
                scene.SetPictureFilename(pictureFilename);
            }
        }
        public void Vinsert_ContentIn() {
            ...
            if (this.insertScene is VRemote4.HandlerSi.Scene &&
                ...
                File.Exists(this.SelectedDataset.PictureFilename)) this.insertScene.ToIn();
        }
