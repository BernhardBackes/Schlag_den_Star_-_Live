...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.PictureTwoTimersScores {
    ...
    public partial class UserControlGame : _Base.TwoTimersScores.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_TwoTimersScoresIn);
            this.stepList.Add(step);
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_TwoTimersScoresOut);
            this.stepList.Add(step);
