...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.Sets;

namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.Sets {
    ...
    public class Business : _Base.Sets.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.Sets'", typeIdentifier);
        }
