...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerSetLargeScore {
    ...
    public partial class UserControlContent : _Base.SetLarge.UserControlContent {
        ...
        private bool previewSceneIsAvailable { get { return this.previewScene is VentuzScenes.GamePool.TimerSetLargeScore.Insert && this.previewScene.Status == VRemote4.HandlerSi.Scene.States.Available; } }
        ...
        public override void SetPreviewPipe(
            VRemote4.HandlerSi.Client.Pipe.Business previewPipe) {
            bool selected = ((VentuzScenes.GamePool.TimerSetLargeScore.Insert)this.previewScene) is VRemote4.HandlerSi.Scene;
        ...
        public override void Select() {
            if (this.previewPipe is VRemote4.HandlerSi.Client.Pipe.Business &&
                ...
                base.select(new VentuzScenes.GamePool.TimerSetLargeScore.Insert(WindowsFormsSynchronizationContext.Current, this.previewPipe));
            }
        }

        protected override void setSetLargePreview() {
            if (this.previewSceneIsAvailable) {
                VentuzScenes.GamePool.TimerSetLargeScore.Insert previewScene = this.previewScene as VentuzScenes.GamePool.TimerSetLargeScore.Insert;
                if (previewScene is VentuzScenes.GamePool.TimerSetLargeScore.Insert) {
                    previewScene.SetLarge.SetPositionX(this.business.SetLargePositionX);
                    previewScene.SetLarge.SetPositionY(this.business.SetLargePositionY);
                    previewScene.SetLarge.SetTopName(this.business.LeftPlayerName);
                    previewScene.SetLarge.SetBottomName(this.business.RightPlayerName);
                    previewScene.SetLarge.SetIn();
                }
            }
        }
        ...
        protected void setScorePreview() {
            if (this.previewSceneIsAvailable) {
                ...
                if (previewScene is VentuzScenes.GamePool.TimerSetLargeScore.Insert) {
                    ...
                    previewScene.Score.SetLeftTopScore(this.business.LeftPlayerScore);
                    previewScene.Score.SetRightBottomName(this.business.RightPlayerName);
                    previewScene.Score.SetRightBottomScore(this.business.RightPlayerScore);
