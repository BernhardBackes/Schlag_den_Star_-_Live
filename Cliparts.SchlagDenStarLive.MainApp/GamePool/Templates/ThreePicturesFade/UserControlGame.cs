...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.ThreePicturesFade {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVfullscreen_Select);
            this.stepList.Add(step);
        ...
        private void buttonVplayers_LiveVideoIn_Click(object sender, EventArgs e) { this.business.Vplayers_LiveVideoIn(); }
