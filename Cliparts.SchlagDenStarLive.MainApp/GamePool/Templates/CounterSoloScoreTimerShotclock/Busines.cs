...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.CounterSoloScoreTimerShotclock;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.CounterSoloScoreTimerShotclock {
    ...
    public class Business : _Base.Score.Business {
        ...
        private int shotclockStartTime = 12;
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.CounterSoloScoreTimerShotclock'", typeIdentifier);
        }
        ...
        protected virtual void sync_shotclock_StopFired(object content) { if (this.insertScene is Insert) this.insertScene.PlaySoundTimeout(); }
