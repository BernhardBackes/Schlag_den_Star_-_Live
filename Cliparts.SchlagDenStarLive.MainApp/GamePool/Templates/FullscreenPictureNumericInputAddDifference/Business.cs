...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.FullscreenPictureNumericInputAddDifference {
    ...
    public class Business : _Base.Score.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.FullscreenPictureNumericInputAddDifference'", typeIdentifier);
        }
        ...
        internal void Vinsert_SetGame(
            ...
            if (scene is Game) {
                ...
                scene.SetLeftPlayerInput(leftPlayerInput);
                scene.SetLeftPlayerDifference(leftPlayerDifference);
                scene.SetRightPlayerInput(rightPlayerInput);
                scene.SetRightPlayerDifference(rightPlayerDifference);
            }
        }
        internal void Vinsert_InputIn() {
            if (this.insertScene is Insert) {
                this.Vinsert_SetGame(this.insertScene.Game, this.LeftPlayerValue, this.LeftPlayerDifference, this.RightPlayerValue, this.RightPlayerDifference);
        ...
        internal void Vinsert_SolutionIn() {
            ...
            this.Vfullscreen_PlayJingleResolvee();
        }
        internal void Vinsert_SetSolution() {
            if (this.insertScene is Insert &&
                this.insertScene.TextInsert is VentuzScenes.GamePool._Modules.TextInsert && 
                this.SelectedDataset is DatasetContent) this.Vinsert_SetSolution(this.insertScene.TextInsert, this.SelectedDataset.Solution);
        }
        internal void Vinsert_SetSolution(
            ...
            if (scene is VentuzScenes.GamePool._Modules.TextInsert) {
                ...
                scene.SetText(solution.ToString());
            }
        }
        public void Vinsert_SolutionOut() {
            if (this.insertScene is Insert &&
        ...
        public void Vfullscreen_PlayJingleResolvee() {
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene) this.fullscreenScene.PlayJingleResolve();
        }
        ...
        internal void Vleftplayer_ContentIn() {
            if (this.LeftPlayerSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.SelectedDataset is DatasetContent) {
                this.leftPlayerScene.SetFilename(this.SelectedDataset.TaskFilename);
        ...
        internal void Vrightplayer_ContentIn() {
            if (this.rightPlayerScene is Player &&
                this.SelectedDataset is DatasetContent) {
                this.rightPlayerScene.SetFilename(this.SelectedDataset.TaskFilename); 
