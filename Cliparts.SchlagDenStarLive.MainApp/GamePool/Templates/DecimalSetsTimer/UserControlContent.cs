...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.DecimalSetsTimer {
    ...
    public partial class UserControlContent : _Base.DecimalSets.UserControlContent {
        ...
        private bool previewSceneIsAvailable { get { return this.previewScene is VentuzScenes.GamePool.DecimalSetsTimer.Insert && this.previewScene.Status == VRemote4.HandlerSi.Scene.States.Available; } }
        ...
        public override void SetPreviewPipe(
            VRemote4.HandlerSi.Client.Pipe.Business previewPipe) {
            bool selected = ((VentuzScenes.GamePool.DecimalSets.Insert)this.previewScene) is VRemote4.HandlerSi.Scene;
        ...
        public override void Select() {
            if (this.previewPipe is VRemote4.HandlerSi.Client.Pipe.Business &&
                ...
                base.select(new VentuzScenes.GamePool.DecimalSets.Insert(WindowsFormsSynchronizationContext.Current, this.previewPipe));
            }
        }

        protected override void setDecimalSetsPreview() {
            if (this.previewSceneIsAvailable) {
                ((VentuzScenes.GamePool.DecimalSets.Insert)this.previewScene).DecimalSets.SetPositionX(this.business.DecimalSetsPositionX);
                ((VentuzScenes.GamePool.DecimalSets.Insert)this.previewScene).DecimalSets.SetPositionY(this.business.DecimalSetsPositionY);
                ((VentuzScenes.GamePool.DecimalSets.Insert)this.previewScene).DecimalSets.SetStyle(this.business.DecimalSetsStyle);
                ((VentuzScenes.GamePool.DecimalSets.Insert)this.previewScene).DecimalSets.SetTopName(this.business.LeftPlayerName);
                ((VentuzScenes.GamePool.DecimalSets.Insert)this.previewScene).DecimalSets.SetBottomName(this.business.RightPlayerName);
                ((VentuzScenes.GamePool.DecimalSets.Insert)this.previewScene).DecimalSets.SetIn();
            }
        }

        protected virtual void setTimerPreview() {
            if (this.previewSceneIsAvailable) {
                VentuzScenes.GamePool.DecimalSetsTimer.Insert previewScene = this.previewScene as VentuzScenes.GamePool.DecimalSetsTimer.Insert;
