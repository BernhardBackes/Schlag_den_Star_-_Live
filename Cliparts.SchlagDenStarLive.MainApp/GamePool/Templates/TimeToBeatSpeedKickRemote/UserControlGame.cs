...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimeToBeatSpeedKickRemote {
    ...
    public partial class UserControlGame : _Base.UserControlGame {
        ...
        public void Pose(
            ...
            this.userControlTimeToBeatSpeedKickRemotePassenClient.Pose(this.business.SpeedKickServerClient);
            this.userControlTimeToBeatSpeedKickRemotePassenClient.BackColor = this.BackColor;

            Binding bind;

            bind = new Binding("ForeColor", this.business, "TimerEnabled");
            bind.Format += (s, e) => { e.Value = (bool)e.Value ? Constants.ColorBuzzered : this.ForeColor; };
            this.groupBoxTimeToBeat.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.userControlTimeToBeatSpeedKickRemotePassenClient.Dispose();

            this.groupBoxTimeToBeat.DataBindings.Clear();
        ...
        protected override void buildStepList() {
            ...
            step.AddButton(this.buttonGame_EnableTimer);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonGame_StartCourse);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonGame_DisableTimer);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonGame_EnableTimer_1);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonGame_StartCourse_01);
            this.stepList.Add(step);
            ...
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_TimeToBeatOut);
            step.AddButton(this.buttonGame_DisableTimer_1);
            this.stepList.Add(step);
        ...
        private void buttonGame_EnableTimer_Click(object sender, EventArgs e) { this.business.TimerEnabled = true; }
        private void buttonGame_StartCourse_Click(object sender, EventArgs e) { this.business.StartCourse(); }
        private void buttonGame_DisableTimer_Click(object sender, EventArgs e) { this.business.TimerEnabled = false; }
