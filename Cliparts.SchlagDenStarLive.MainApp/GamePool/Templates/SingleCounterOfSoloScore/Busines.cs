...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SingleCounterOfSoloScore {
    ...
    public class Business : _Base.Score.Business {
        ...
        private string title = "Runde";
        public string Title {
            get { return this.title; }
            set {
                if (this.title != value) {
                    if (string.IsNullOrEmpty(value)) this.title = string.Empty;
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.SingleCounterOfSoloScore'", typeIdentifier);
        }
        ...
        public virtual void ReleaseBuzzer() {
            ...
            if (this.BuzzerChannel > 0 &&
                this.BuzzerChannel <= inputMask.Length)
                inputMask[this.BuzzerChannel - 1] = true;
        ...
        public void Vinsert_SetCounter(VentuzScenes.GamePool._Modules.SingleCounterOf scene) { this.Vinsert_SetCounter(scene, this.Counter); }
        public void Vinsert_SetCounter(
            ...
            if (scene is VentuzScenes.GamePool._Modules.SingleCounterOf) {
                ...
                scene.SetStyle(VentuzScenes.GamePool._Modules.SingleCounterOf.StyleElements.Titled);
                scene.SetTitle(this.Title);
                scene.SetTarget(this.Target);
        ...
        private void sync_buzzerHandler_BuzUnit_Buzzered(object content) {
            ...
            if (this.isActive &&
                ...
                if (e.Arg.BuzzerID == this.BuzzerChannel) this.DoCounter();
            }
        }
