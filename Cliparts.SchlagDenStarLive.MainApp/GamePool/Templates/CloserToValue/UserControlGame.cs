...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.CloserToValue {
    ...
    public partial class UserControlGame : _Base.TimerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_TargetValueIn);
            this.stepList.Add(step);
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_PlayerIn);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ResolvePlayer);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_PlayerOut);
            step.AddButton(this.buttonVinsert_TargetValueOut);
            this.stepList.Add(step);
        ...
        private void buttonVinsert_TargetValueIn_Click(object sender, EventArgs e) { this.business.Vinsert_TargetValueIn(); }
        private void buttonVinsert_PlayerIn_Click(object sender, EventArgs e) { this.business.Vinsert_PlayerIn(); }
        private void buttonVinsert_ResolvePlayer_Click(object sender, EventArgs e) { this.business.Vinsert_ResolvePlayer(); }
        private void buttonVinsert_PlayerOut_Click(object sender, EventArgs e) { this.business.Vinsert_PlayerOut(); }
        private void buttonVinsert_TargetValueOut_Click(object sender, EventArgs e) { this.business.Vinsert_TargetValueOut(); }
