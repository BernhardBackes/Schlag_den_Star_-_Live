...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TwoPicturesFadeNumericInputAddDifference {
    ...
    public class DatasetContent : Messaging.Message, INotifyPropertyChanged {
        ...
        public string SolutionFilename {
            ...
            set {
                if (this.solutionFilename != value) {
                    ...
                    this.SolutionThumb = Helper.getThumbnailFromMediaFile(this.solutionFilename);
                    this.on_PropertyChanged();
                }
            }
        }
        ...
        [XmlIgnore]
        public Image SolutionThumb { get; private set; }
        ...
        public string Credit {
            ...
            set {
                if (this.credit != value) {
                    if (string.IsNullOrEmpty(value)) this.credit = string.Empty;
                    else this.credit = value;
                    this.on_PropertyChanged();
                }
            }
        }
    ...
    public class Business : _Base.Score.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TwoPicturesFadeNumericInputAddDifference'", typeIdentifier);
        }
        ...
        internal void Vinsert_SetGame(
            ...
            string credit) {
            if (scene is Insert) {
                scene.Game.SetTaskFilename(taskFile);
                scene.Game.SetSolutionFilename(solutionFile);
                scene.Game.SetCredit(credit);
            }
        }
        internal void Vinsert_SetGame(
            Insert scene,
        ...
        internal void Vinsert_TaskIn() {
            if (this.insertScene is Insert) {
                if (this.SelectedDataset is DatasetContent) this.Vinsert_SetGame(this.insertScene, this.SelectedDataset.TaskFilename, this.SelectedDataset.SolutionFilename, this.SelectedDataset.Credit);
