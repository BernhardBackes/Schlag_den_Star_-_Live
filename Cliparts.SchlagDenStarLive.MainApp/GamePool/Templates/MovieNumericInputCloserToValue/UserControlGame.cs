...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.MovieNumericInputCloserToValue {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVfullscreen_PlayMovie);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonVfullscreen_ContinueMovie);
            this.stepList.Add(step);
        ...
        private void numericUpDownLeftPlayerValue_ValueChanged(object sender, EventArgs e) { this.business.LeftPlayerValue = (float)this.numericUpDownLeftPlayerValue.Value; }
        private void numericUpDownRightPlayerValue_ValueChanged(object sender, EventArgs e) { this.business.RightPlayerValue = (float)this.numericUpDownRightPlayerValue.Value; }
        ...
        private void buttonVfullscreen_PlayMovie_Click(object sender, EventArgs e) { this.business.Vfullscreen_PlayMovie(); }
        private void buttonVfullscreen_ContinueMovie_Click(object sender, EventArgs e) { this.business.Vfullscreen_ContinueMovie(); }
