...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimeToBeatSpeedKick {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        public void Pose(
            ...
            bind = new Binding("Text", this.business, "Remaining");
            bind.Format += (s, e) => { e.Value = e.Value.ToString(); };
            this.textBoxRemaining.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.textBoxRemaining.DataBindings.Clear();
        }
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_StopTimeToBeat_1);
