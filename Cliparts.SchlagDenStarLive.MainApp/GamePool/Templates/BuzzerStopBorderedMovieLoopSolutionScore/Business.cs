...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.BuzzerStopBorderedMovieLoopSolutionScore {
    ...
    public class DatasetContent : Messaging.Message, INotifyPropertyChanged {
        ...
        private Fullscreen.FormatElements format = Fullscreen.FormatElements.Format_16to9;
        public Fullscreen.FormatElements Format {
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.BuzzerStopBorderedMovieLoopSolutionScore'", typeIdentifier);
        }
        ...
        public void Vfullscreen_ContentIn() {
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene &&
                ...
                this.Vfullscreen_SetContent(this.fullscreenScene, this.SelectedDataset.Format, this.SelectedDataset.TaskFilename, this.LoopTask, this.SelectedDataset.SolutionFilename);
                this.fullscreenScene.ToIn();
            }
        }
        public void Vfullscreen_SetContent(
            Fullscreen scene,
            Fullscreen.FormatElements format,
            string taskFilename,
            bool loopTask,
        ...
        public void Vfullscreen_ShowSolution() { if (this.fullscreenScene is VRemote4.HandlerSi.Scene) this.fullscreenScene.ShowSolution(); }
        public void Vfullscreen_StartSolution() {
            this.Vfullscreen_SetTextInsert();
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene) {
                this.fullscreenScene.StartSolution();
                Helper.invokeActionAfterDelay(this.fullscreenScene.TextInsert.ToIn, 500, this.syncContext);
            }
        }
