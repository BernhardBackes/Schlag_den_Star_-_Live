...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.BuzzerStopBorderedMovieLoopSolutionScore {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            step.AddButton(this.buttonVfullscreen_PauseTask);
            ...
            step.AddButton(this.buttonVplayers_ContentOut_1);
        ...
        private void buttonVfullscreen_PauseTask_Click(object sender, EventArgs e) { this.business.Vfullscreen_PauseTask(); }
        ...
        private void buttonVplayers_ContentOut_1_Click(object sender, EventArgs e) { this.business.Vplayers_ContentOut(); }
