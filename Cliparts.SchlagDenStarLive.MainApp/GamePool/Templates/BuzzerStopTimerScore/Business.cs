...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.BuzzerStopTimerScore;

namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.BuzzerStopTimerScore {

    public class Business : _Base.BuzzerStopTimerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.BuzzerStopTimerScore'", typeIdentifier);
        }
