...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimeToBeatSpeedKick {
    ...
    public partial class UserControlGame : _Base.UserControlGame {
        ...
        protected virtual void numericUpDownLeftPlayerScore_ValueChanged(object sender, EventArgs e) {}
        protected virtual void buttonLeftPlayerAddScoreHot_01_Click(object sender, EventArgs e) {
        }

        protected virtual void numericUpDownRightPlayerScore_ValueChanged(object sender, EventArgs e) {}
        ...
        private void buttonSetBuzzerTop_Click(object sender, EventArgs e) {}
        private void buttonSetBuzzerLeft_Click(object sender, EventArgs e) { }
        private void buttonSetBuzzerRight_Click(object sender, EventArgs e) { }
        private void buttonSetBuzzerBottom_Click(object sender, EventArgs e) {  }
        private void buttonNextBuzzer_Click(object sender, EventArgs e) { this.business.NextBuzzer(); }

        protected virtual void buttonVinsert_ScoreIn_Click(object sender, EventArgs e) {  }
        protected virtual void buttonVinsert_SetScore_Click(object sender, EventArgs e) { }
        protected virtual void buttonVinsert_ScoreOut_Click(object sender, EventArgs e) {  }

        protected virtual void buttonVstage_Init_Click(object sender, EventArgs e) {}
        protected virtual void buttonVstage_SetScore_Click(object sender, EventArgs e) { }
