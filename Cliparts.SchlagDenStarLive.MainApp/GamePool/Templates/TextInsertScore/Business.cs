...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TextInsertScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TextInsertScore {
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TextInsertScore'", typeIdentifier);
        }
