    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        public void Pose(
            ...
            for (int i = 0; i < Business.TaskCounterPenaltyCountMax; i++) {
                UserControlGamePoolTemplatesBokTaskCounterSingleDot userControlGamePoolTemplatesTaskCounterSingleDot;
                Label labelCounter;
                int left;
                if (i == 0) {
                    ...
                    userControlGamePoolTemplatesTaskCounterSingleDot = new UserControlGamePoolTemplatesBokTaskCounterSingleDot();
        ...
        protected override void Dispose(bool disposing) {
            ...
            UserControlGamePoolTemplatesBokTaskCounterSingleDot control;
            string key;
            for (int i = 0; i < Business.TaskCounterPenaltyCountMax; i++) {
                key = "userControlGamePoolTemplatesTaskCounterSingleDot_" + i.ToString("00");
                control = this.Controls[key] as UserControlGamePoolTemplatesBokTaskCounterSingleDot;
                if (control is UserControlGamePoolTemplatesBokTaskCounterSingleDot) {
                    control.Dispose();
                }
            }
