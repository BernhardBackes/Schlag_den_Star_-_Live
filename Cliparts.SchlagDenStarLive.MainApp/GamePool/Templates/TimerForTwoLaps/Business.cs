...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TimerForTwoLaps;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerForTwoLaps {
    ...
    public class Business : _Base.Score.Business {
        ...
        private Insert.Styles timerStyle = Insert.Styles.FourDots;
        ...
        private int leftPlayerCurrentLap = 0;
        public int LeftPlayerCurrentLap {
            get { return this.leftPlayerCurrentLap; }
            set {
                if (this.leftPlayerCurrentLap != value) {
                    if (value < 0) this.leftPlayerCurrentLap = 0;
                    if (value > this.LAPsCount) this.leftPlayerCurrentLap = this.LAPsCount;
                    else this.leftPlayerCurrentLap = value;
                    this.on_PropertyChanged();
                }
            }
        }

        private int rightPlayerCurrentLap = 0;
        public int RightPlayerCurrentLap {
            get { return this.rightPlayerCurrentLap; }
            set {
                if (this.rightPlayerCurrentLap != value) {
                    if (value < 0) this.rightPlayerCurrentLap = 0;
                    if (value > this.LAPsCount) this.rightPlayerCurrentLap = this.LAPsCount;
                    else this.rightPlayerCurrentLap = value;
                    this.on_PropertyChanged();
                }
            }
        }
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TimerForTwoLaps'", typeIdentifier);
        }
        ...
        public override void ResetData() {
            ...
            this.LeftPlayerCurrentLap = 0;
            this.RightPlayerCurrentLap = 0;
        }

        public virtual void PassFinishLine(
            PlayerSelection finisher) {
            if (finisher != PlayerSelection.NotSelected) {
                int currentLap = this.LeftPlayerCurrentLap;
                if (finisher == PlayerSelection.RightPlayer) currentLap = this.RightPlayerCurrentLap;
                if (currentLap == this.LAPsCount) {
                ...
                switch (finisher) {
                    case PlayerSelection.LeftPlayer:
                        this.LeftPlayerCurrentLap++;
                        break;
                    case PlayerSelection.RightPlayer:
                        this.RightPlayerCurrentLap++;
                        break;
                }
                this.Vinsert_SetTimer();
            }
        ...
        public void Vinsert_SetTimer() { if (this.insertScene is VRemote4.HandlerSi.Scene) this.Vinsert_SetTimer(this.insertScene, this.LeftPlayerScore, this.LeftPlayerCurrentLap, this.RightPlayerScore, this.RightPlayerCurrentLap); }
        ...
        public void Vinsert_StartTimer() {
            ...
            this.LeftPlayerCurrentLap = 1;
            this.RightPlayerCurrentLap = 1;
            this.Vinsert_SetTimer();
        }
