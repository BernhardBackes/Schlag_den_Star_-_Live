...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerForTwoLaps {
    ...
    public partial class UserControlContent : _Base.Score.UserControlContent {
        ...
        public UserControlContent() {
            ...
            this.comboBoxTimerStyle.Items.AddRange(Enum.GetNames(typeof(VentuzScenes.GamePool.TimerForTwoLaps.Insert.Styles)));
        ...
        protected void setTimerPreview() {
            if (this.previewSceneIsAvailable) {
                ...
                this.business.Vinsert_SetTimer(previewScene.Insert, 2, 1, 3, 2);                
        ...
        protected virtual void comboBoxTimerStyle_SelectedIndexChanged(object sender, EventArgs e) {
            VentuzScenes.GamePool.TimerForTwoLaps.Insert.Styles style;
