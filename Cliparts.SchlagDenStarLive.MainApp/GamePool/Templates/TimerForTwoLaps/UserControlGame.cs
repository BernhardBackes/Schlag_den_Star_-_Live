...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerForTwoLaps {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        public UserControlGame() {
            ...
            this.numericUpDownLeftPlayerCurrentLap.Minimum = int.MinValue;
            this.numericUpDownLeftPlayerCurrentLap.Maximum = int.MaxValue;

            this.numericUpDownRightPlayerCurrentLap.Minimum = int.MinValue;
            this.numericUpDownRightPlayerCurrentLap.Maximum = int.MaxValue;
        ...
        public void Pose(
            ...
            bind = new Binding("Value", this.business, "LeftPlayerCurrentLap");
            bind.Format += (s, e) => { e.Value = (int)e.Value; };
            this.numericUpDownLeftPlayerCurrentLap.DataBindings.Add(bind);

            bind = new Binding("Text", this.business, "LAPsCount");
            bind.Format += (s, e) => { e.Value = "/" + e.Value.ToString(); };
            this.labelLeftPlayerCurrentLapsCount.DataBindings.Add(bind);

            bind = new Binding("Value", this.business, "RightPlayerCurrentLap");
            bind.Format += (s, e) => { e.Value = (int)e.Value; };
            this.numericUpDownRightPlayerCurrentLap.DataBindings.Add(bind);

            bind = new Binding("Text", this.business, "LAPsCount");
            bind.Format += (s, e) => { e.Value = "/" + e.Value.ToString(); };
            this.labelRightPlayerCurrentLapsCount.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.numericUpDownLeftPlayerCurrentLap.DataBindings.Clear();
            this.labelLeftPlayerCurrentLapsCount.DataBindings.Clear();
            this.numericUpDownRightPlayerCurrentLap.DataBindings.Clear();
            this.labelRightPlayerCurrentLapsCount.DataBindings.Clear();
        ...
        private void numericUpDownLeftPlayerCurrentLap_ValueChanged(object sender, EventArgs e) { this.business.LeftPlayerCurrentLap = (int)this.numericUpDownLeftPlayerCurrentLap.Value; }
        ...
        private void numericUpDownRightPlayerCurrentLap_ValueChanged(object sender, EventArgs e) { this.business.RightPlayerCurrentLap = (int)this.numericUpDownRightPlayerCurrentLap.Value; }
