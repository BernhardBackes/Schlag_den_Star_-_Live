...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.WindingQuiz {
    ...
    public partial class UserControlGamePoolTemplatesWindingQuizTaskCounterSingleDot : UserControl {
        ...
        public UserControlGamePoolTemplatesWindingQuizTaskCounterSingleDot() {
            InitializeComponent();
        }
