    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        public void Pose(
            ...
            for (int i = 0; i < Business.TaskCounterPenaltyCountMax; i++) {
                UserControlGamePoolTemplatesWindingQuizTaskCounterSingleDot userControlGamePoolTemplatesTaskCounterSingleDot;
                Label labelCounter;
                int left;
                if (i == 0) {
                    ...
                    userControlGamePoolTemplatesTaskCounterSingleDot = new UserControlGamePoolTemplatesWindingQuizTaskCounterSingleDot();
        ...
        protected override void Dispose(bool disposing) {
            ...
            UserControlGamePoolTemplatesWindingQuizTaskCounterSingleDot control;
            string key;
            for (int i = 0; i < Business.TaskCounterPenaltyCountMax; i++) {
                key = "userControlGamePoolTemplatesTaskCounterSingleDot_" + i.ToString("00");
                control = this.Controls[key] as UserControlGamePoolTemplatesWindingQuizTaskCounterSingleDot;
                if (control is UserControlGamePoolTemplatesWindingQuizTaskCounterSingleDot) {
                    control.Dispose();
                }
            }
