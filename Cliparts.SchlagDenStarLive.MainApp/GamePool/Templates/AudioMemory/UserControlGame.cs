...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.AudioMemory {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        public void Pose(
            ...
            object[] items = new object[] { "reset", "start audio", "to in", "set selected", "to selected", "set out", "to out" };
            ...
            for (int i = 1; i < Business.CardsCount; i++) {
                int id = i + 1;
                int column = i % 7;
                int row = i / 7;
        ...
        protected override void buildStepList() {
            ...
            step.AddButton(this.buttonVfullscreen_StartNext);
            step.AddButton(this.buttonVstage_SetScore);
            step.AddButton(this.buttonVgameboard_StartNext);
            this.stepList.Add(step);
        ...
        private void buttonVfullscreen_StartNext_Click(object sender, EventArgs e) { this.business.Vfullscreen_Next(); }
        ...
        private void buttonVgameboard_StartNext_Click(object sender, EventArgs e) { this.business.Vgameboard_Next(); }
        ...
        private void comboBoxGameboardCard_SelectedIndexChanged(object sender, EventArgs e) {
            ...
            if (comboBoxGameboardCard is ComboBox &&
                ...
                if (Helper.tryParseIndexFromControl(comboBoxGameboardCard, out index)) {
                    ...
                    else if (comboBoxGameboardCard.Text == "start audio") {
                        this.business.Vfullscreen_StartAudio(index + 1);
                        this.business.Vgameboard_StartAudio(index + 1);
                    }
