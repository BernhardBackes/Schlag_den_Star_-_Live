...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.LargeNumbers {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        private void buttonVinsert_Resolve_Click(object sender, EventArgs e) { this.business.Vinsert_ResolveInput(); }
        ...
        private void buttonVplayers_Unlock_Click(object sender, EventArgs e) {
            this.business.Vleftplayer_UnlockInput();
            this.business.Vrightplayer_UnlockInput();
        }
