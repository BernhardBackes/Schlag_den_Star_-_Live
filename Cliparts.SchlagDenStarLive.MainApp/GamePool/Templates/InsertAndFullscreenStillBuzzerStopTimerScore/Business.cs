...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.InsertAndFullscreenStillBuzzerStopTimerScore {
    ...
    public class DatasetContent : Messaging.Message, INotifyPropertyChanged {
        ...
        private string insertFilename = string.Empty;
        public string InsertFilename {
            get { return this.insertFilename; }
            set {
                if (this.insertFilename != value) {
                    if (value == null) value = string.Empty;
                    this.insertFilename = value;
                    this.Insert = Helper.getThumbnailFromMediaFile(value);
        ...
        [XmlIgnore]
        public Image Insert { get; private set; }

        private string fullscreenFilename = string.Empty;
        public string FullscreenFilename {
            get { return this.fullscreenFilename; }
            set {
                if (this.fullscreenFilename != value) {
                    if (value == null) value = string.Empty;
                    this.fullscreenFilename = value;
                    this.Fullscreen = Helper.getThumbnailFromMediaFile(value);
                    this.on_PropertyChanged();
                }
            }
        }
        ...
        [XmlIgnore]
        public Image Fullscreen { get; private set; }
        ...
        public DatasetContent(
            ...
            if (string.IsNullOrEmpty(pictureFilename)) {
                this.Name = "?";
                this.InsertFilename = string.Empty;
            }
            else {
                this.Name = Path.GetFileNameWithoutExtension(pictureFilename);
                this.InsertFilename = pictureFilename;
            }
        }
    ...
    public class Business : _Base.BuzzerTimerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.InsertAndFullscreenStillBuzzerStopTimerScore'", typeIdentifier);
        }
        ...
        public void Vinsert_ContentIn() {
            if (this.insertScene is VRemote4.HandlerSi.Scene &&
                ...
                this.Vinsert_SetContent(this.insertScene, this.SelectedDataset.InsertFilename);
        ...
        public void Vfullscreen_ContentIn() {
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene &&
                this.SelectedDataset is DatasetContent) {
                this.Vfullscreen_SetContent(this.fullscreenScene, this.SelectedDataset.FullscreenFilename, this.SelectedDataset.Name);
