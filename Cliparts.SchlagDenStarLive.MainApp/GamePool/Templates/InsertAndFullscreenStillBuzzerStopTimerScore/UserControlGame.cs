    ...
    public partial class UserControlGame : _Base.BuzzerTimerScore.UserControlGame {
        ...
        private void selectDataset(
            ...
            if (this.selectedDataset is DatasetContent) {
                ...
                this.pictureBoxDatasetPicture.Image = this.selectedDataset.Fullscreen;
            }
            else {
        ...
        void selectedDataset_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.selectedDataset_PropertyChanged(sender, e)));
                ...
                if (e.PropertyName == "FullscreenFilename") this.pictureBoxDatasetPicture.Image = this.selectedDataset.Fullscreen;
            }
        }
