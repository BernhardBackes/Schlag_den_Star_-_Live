...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SixHintsOneSolution {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ItemIn_01);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ItemIn_02);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ItemIn_03);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ItemIn_04);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ItemIn_05);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ItemIn_06);
            this.stepList.Add(step);
        ...
        private void buttonVinsert_ItemIn_01_Click(object sender, EventArgs e) { this.business.Vinsert_ItemIn(1); }
        private void buttonVinsert_ItemIn_02_Click(object sender, EventArgs e) { this.business.Vinsert_ItemIn(2); }
        private void buttonVinsert_ItemIn_03_Click(object sender, EventArgs e) { this.business.Vinsert_ItemIn(3); }
        private void buttonVinsert_ItemIn_04_Click(object sender, EventArgs e) { this.business.Vinsert_ItemIn(4); }
        private void buttonVinsert_ItemIn_05_Click(object sender, EventArgs e) { this.business.Vinsert_ItemIn(5); }
        private void buttonVinsert_ItemIn_06_Click(object sender, EventArgs e) { this.business.Vinsert_ItemIn(6); }
