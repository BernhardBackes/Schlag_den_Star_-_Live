...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TimerCounterToBeatTextInsert;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerCounterToBeatTextInsert {
    ...
    public class Business : _Base.Timer.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TimerCounterToBeatTextInsert'", typeIdentifier);
        }
        ...
        public override void Next() {
            base.Next();
            if (this.SelectedDatasetIndex + 1 < this.DatasetsCount) {
                this.TaskCounter++;
                this.SelectDataset(this.SelectedDatasetIndex + 1);
            }
            else {
                this.Vfullscreen_StopTimer();
                this.Vinsert_Timer.Stop();
            }
        }
        ...
        public void True() {
            this.CounterValue++;
            this.CounterTime = this.Vinsert_Timer.CurrentTime;
            this.Next();
            this.Vinsert_SetCounter();
            this.Vinsert_SetContent();
        }
        ...
        internal void Vinsert_SetContent() { 
            if (this.insertScene is VRemote4.HandlerSi.Scene &&
                this.SelectedDataset is DatasetContent) this.Vinsert_SetContent(this.insertScene.TextInsert, this.SelectedDataset.Text); 
        }
        internal void Vinsert_SetContent(
