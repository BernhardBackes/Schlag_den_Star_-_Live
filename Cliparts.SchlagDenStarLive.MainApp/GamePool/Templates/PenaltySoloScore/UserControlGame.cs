...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.PenaltySoloScore {
    ...
    public partial class UserControlGame : _Base.Penalty.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            step.AddButton(this.buttonVinsert_SetPenalty);
            this.stepList.Add(step);
        ...
        protected virtual void buttonVinsert_SetPenalty_Click(object sender, EventArgs e) { this.business.Vinsert_SetPenalty(); }
        protected virtual void buttonVinsert_PenaltyOut_Click(object sender, EventArgs e) { this.business.Vinsert_PenaltyOut(); }
