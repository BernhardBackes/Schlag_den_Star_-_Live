...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TargetCounterSoloScore{
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        public void Pose(
            ...
            bind = new Binding("Visible", this.business, "LeftBuzzerLocked");
            bind.Format += (s, e) => { e.Value = (bool)e.Value; };
            this.panelBuzzerLeftLocked.DataBindings.Add(bind);

            bind = new Binding("Visible", this.business, "RightBuzzerLocked");
            bind.Format += (s, e) => { e.Value = (bool)e.Value; };
            this.panelBuzzerRightLocked.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.textBoxIOUnitName.DataBindings.Clear();
            this.panelBuzzerLeftLocked.DataBindings.Clear();
            this.panelBuzzerRightLocked.DataBindings.Clear();
        ...
        private void buttonBuzzerLeft_Click(object sender, EventArgs e) { if (this.business is Business) this.business.DoCounter(Content.Gameboard.PlayerSelection.LeftPlayer); }
        private void buttonBuzzerRight_Click(object sender, EventArgs e) { if (this.business is Business) this.business.DoCounter(Content.Gameboard.PlayerSelection.RightPlayer); }
