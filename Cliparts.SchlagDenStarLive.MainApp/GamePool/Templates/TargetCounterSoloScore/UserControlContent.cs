...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TargetCounterSoloScore{
    ...
    public partial class UserControlContent : _Base.Score.UserControlContent {
        ...
        public void Pose(
            ...
            bind = new Binding("Value", this.business, "CounterTarget");
            bind.Format += (s, e) => { e.Value = (int)e.Value; };
        ...
        private void numericUpDownCounterTarget_ValueChanged(object sender, EventArgs e) { if (this.business is Business) this.business.CounterTarget = (int)this.numericUpDownCounterTarget.Value; }
