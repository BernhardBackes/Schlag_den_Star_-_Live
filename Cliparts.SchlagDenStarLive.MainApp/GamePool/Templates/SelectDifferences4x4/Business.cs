...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.SelectDifferences4x4;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SelectDifferences4x4 {
    ...
    public class DatasetContent : Messaging.Message, INotifyPropertyChanged {
        ...
        public const int FramesCount = 16;
    ...
    public class Business : _Base.Score.Business {
        ...
        public Insert.Style BackgroundStyle {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.SelectDifferences4x4'", typeIdentifier);
        }
