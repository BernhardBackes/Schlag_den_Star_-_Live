    ...
    public partial class UserControlGame : _Base.TimerScore.UserControlGame {
        ...
        public void Pose(
            ...
            for (int i = 0; i < Business.IndicatorsCountMax; i++) {
                UserControlGamePoolTemplatesRGBIndicatorsScoreIndicator userControlIndicator;
                Label labelCounter;
                int left;
                ...
                if (i == 0) {
                    ...
                    left = this.userControlIndicator_00.Left + width * i;
                    userControlIndicator = new UserControlGamePoolTemplatesRGBIndicatorsScoreIndicator();
                    userControlIndicator.Left = left;
                    userControlIndicator.Name = "userControlIndicator_" + i.ToString("00");
                ...
                userControlIndicator.Pose(this.business.Indicators[i]);
            }
        ...
        protected override void business_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            ...
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.business_PropertyChanged(sender, e)));
                ...
                if (e.PropertyName == "IndicatorsCount") this.adjustUserControlDots();
            }
        }
