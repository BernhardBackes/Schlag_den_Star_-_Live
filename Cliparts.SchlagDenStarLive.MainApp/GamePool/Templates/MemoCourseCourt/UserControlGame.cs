...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.MemoCourseCourt {
    ...
    public partial class UserControlGame : _Base.UserControlGame {
        ...
        private void listBoxTasks_SelectedIndexChanged(object sender, EventArgs e) { this.business.SelectTask(this.listBoxTasks.Text); }
        ...
        private void buttonSequenceIn_Click(object sender, EventArgs e) {
            this.business.Vinsert_CourseIn();
            this.business.Vfullscreen_CourseIn();
        }
        private void buttonSequenceOut_Click(object sender, EventArgs e) {
            this.business.Vinsert_CourseOut();
            this.business.Vfullscreen_CourseOut();
        }
        ...
        private void buttonVinsert_SequenceIn_Click(object sender, EventArgs e) { this.business.Vinsert_CourseIn(); }
        private void buttonVinsert_SequenceOut_Click(object sender, EventArgs e) { this.business.Vinsert_CourseOut(); }
        ...
        private void buttonVfullscreen_SequenceIn_Click(object sender, EventArgs e) { this.business.Vfullscreen_CourseIn(); }
        private void buttonVfullscreen_SequenceOut_Click(object sender, EventArgs e) { this.business.Vfullscreen_CourseOut(); }
