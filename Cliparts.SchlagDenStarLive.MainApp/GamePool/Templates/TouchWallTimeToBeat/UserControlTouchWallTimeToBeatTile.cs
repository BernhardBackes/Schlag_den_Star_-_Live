...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TouchWallTimeToBeat {
    ...
    public partial class UserControlTouchWallTimeToBeatTile : UserControl {
        ...
        public UserControlTouchWallTimeToBeatTile() {
            InitializeComponent();
        ...
        private void buttonSetOn_Click(object sender, EventArgs e) { this.tile.SetLightOn(); }
        private void buttonSetOff_Click(object sender, EventArgs e) { this.tile.SetLightOff(); }
