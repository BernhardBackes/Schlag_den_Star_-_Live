...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TouchWallTimeToBeat {
    ...
    public partial class UserControlGame : _Base.UserControlGame {
        ...
        public void Pose(
            ...
            bind = new Binding("SelectedIndex", this.business, "SelectedTileCrowdIndex");
            bind.Format += (s, e) => { e.Value = (int)e.Value; };
            this.listBoxTileCrowdList.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.listBoxTileCrowdList.DataBindings.Clear();
        }
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonGame_SelectSample);
            this.stepList.Add(step);
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonGame_SelectChallenge);
            this.stepList.Add(step);
        ...
        private void fillListBoxTileCrowdList() {
            ...
            this.listBoxTileCrowdList.Items.AddRange(this.business.SelectedTileCrowdList);
        ...
        protected override void business_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            ...
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.business_PropertyChanged(sender, e)));
                ...
                else if (e.PropertyName == "SelectedTileCrowdList") this.fillListBoxTileCrowdList();
            }
        }
        ...
        private void listBoxTileCrowdList_Click(object sender, EventArgs e) { this.business.SelectedTileCrowdIndex = this.listBoxTileCrowdList.SelectedIndex; }
        ...
        private void buttonGame_SelectSample_Click(object sender, EventArgs e) { this.business.SelectSample(); }
        private void buttonGame_SelectChallenge_Click(object sender, EventArgs e) { this.business.SelectChallenge(); }
