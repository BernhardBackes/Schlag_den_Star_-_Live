...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates._Base.BuzzerStartTimerScore {
    ...
    public class Business : _Base.Business {
        ...
        protected void leftTimer_Alarm1Fired(object sender, EventArgs e) {
        ...
        protected void leftTimer_Alarm2Fired(object sender, EventArgs e) {
        ...
        protected void leftTimer_StopFired(object sender, EventArgs e) {
        ...
        protected void leftTimer_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e) {
