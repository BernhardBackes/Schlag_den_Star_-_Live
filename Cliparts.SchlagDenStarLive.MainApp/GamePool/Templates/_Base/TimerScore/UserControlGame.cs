...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates._Base.TimerScore {
    ...
    public partial class UserControlGame : _Base.UserControlGame {
        ...
        public void Pose(
            ...
            bind = new Binding("Enabled", this.business, "ShowFullscreenScore");
            bind.Format += (s, e) => { e.Value = (bool)e.Value; };
            this.buttonVfullscreen_ShowScore.DataBindings.Add(bind);

            bind = new Binding("Enabled", this.business, "ShowFullscreenScore");
            bind.Format += (s, e) => { e.Value = (bool)e.Value; };
            this.buttonVfullscreen_SetScore.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.buttonVfullscreen_ShowScore.DataBindings.Clear();
            this.buttonVfullscreen_SetScore.DataBindings.Clear();
        }
        ...
        private void buttonVfullscreen_SetScore_Click(object sender, EventArgs e)
        {
