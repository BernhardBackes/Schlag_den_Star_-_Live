...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates._Base.TimerScore {
    ...
    public partial class UserControlContent : _Base.UserControlContent {
        ...
        public UserControlContent() {
            ...
            this.numericUpDownTimerScaling.Minimum = decimal.MinValue;
            this.numericUpDownTimerScaling.Maximum = decimal.MaxValue;
        ...
        public void Pose(
            ...
            bind = new Binding("Value", this.business, "TimerScaling");
            bind.Format += (s, e) => { e.Value = (double)e.Value; };
            this.numericUpDownTimerScaling.DataBindings.Add(bind);
            ...
            bind = new Binding("Checked", this.business, "ShowFullscreenScore");
            bind.Format += (s, e) => { e.Value = (bool)e.Value; };
            this.checkBoxScoreShowFullscreenScore.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.numericUpDownTimerScaling.DataBindings.Clear();
            ...
            this.checkBoxScoreShowFullscreenScore.DataBindings.Clear();
        ...
        private void numericUpDownTimerScaling_ValueChanged(object sender, EventArgs e) {
            if (this.business is Business) {
                this.business.TimerScaling = (int)this.numericUpDownTimerScaling.Value;
                this.setTimerPreview();
            }
        }
        ...
        private void checkBoxScoreShowFullscreenScore_CheckedChanged(object sender, EventArgs e) { if (this.business is Business) this.business.ShowFullscreenScore = this.checkBoxScoreShowFullscreenScore.Checked; }
