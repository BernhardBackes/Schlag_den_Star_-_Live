...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimeToBeatScore {
    ...
    public partial class UserControlContent : _Base.Score.UserControlContent {
        ...
        public UserControlContent() {
            ...
            this.numericUpDownSportIconsPositionX.Minimum = int.MinValue;
            this.numericUpDownSportIconsPositionX.Maximum = int.MaxValue;

            this.numericUpDownSportIconsPositionY.Minimum = int.MinValue;
            this.numericUpDownSportIconsPositionY.Maximum = int.MaxValue;
        ...
        public void Pose(
            ...
            bind = new Binding("Value", this.business, "SportIconsPositionX");
            bind.Format += (s, e) => { e.Value = (int)e.Value; };
            this.numericUpDownSportIconsPositionX.DataBindings.Add(bind);

            bind = new Binding("Value", this.business, "SportIconsPositionY");
            bind.Format += (s, e) => { e.Value = (int)e.Value; };
            this.numericUpDownSportIconsPositionY.DataBindings.Add(bind);

            bind = new Binding("Checked", this.business, "UseSportIcons");
            bind.Format += (s, e) => { e.Value = (bool)e.Value; };
            this.checkBoxUseSportIcons.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.numericUpDownSportIconsPositionX.DataBindings.Clear();
            this.numericUpDownSportIconsPositionY.DataBindings.Clear();
            this.checkBoxUseSportIcons.DataBindings.Clear();
        ...
        protected void setSportIconsPreview() {
            if (this.previewSceneIsAvailable) {
                if (this.showTimeToBeat &&
                    this.business.UseSportIcons) {
                    ((Preview)this.previewScene).Insert.SportIcons.SetPositionX(this.business.SportIconsPositionX);
                    ((Preview)this.previewScene).Insert.SportIcons.SetPositionY(this.business.SportIconsPositionY);
                    ((Preview)this.previewScene).Insert.SportIcons.SetBasketball(VentuzScenes.GamePool._Modules.SportIcons.States.In);
                    ((Preview)this.previewScene).Insert.SportIcons.SetHockey(VentuzScenes.GamePool._Modules.SportIcons.States.In);
                    ((Preview)this.previewScene).Insert.SportIcons.SetCan(VentuzScenes.GamePool._Modules.SportIcons.States.Out);
                    ((Preview)this.previewScene).Insert.SportIcons.SetSoccer(VentuzScenes.GamePool._Modules.SportIcons.States.Out);
                    ((Preview)this.previewScene).Insert.SportIcons.SetIn();
                }
                else ((Preview)this.previewScene).Insert.SportIcons.SetOut();
            }
        }
        ...
        protected virtual void numericUpDownSportIconsPositionX_ValueChanged(object sender, EventArgs e) {
            this.business.SportIconsPositionX = (int)this.numericUpDownSportIconsPositionX.Value;
            this.setSportIconsPreview();
        }
        protected virtual void numericUpDownSportIconsPositionY_ValueChanged(object sender, EventArgs e) {
            this.business.SportIconsPositionY = (int)this.numericUpDownSportIconsPositionY.Value;
            this.setSportIconsPreview();
        }
        private void checkBoxUseSportIcons_CheckedChanged(object sender, EventArgs e) { this.business.UseSportIcons = this.checkBoxUseSportIcons.Checked; }
