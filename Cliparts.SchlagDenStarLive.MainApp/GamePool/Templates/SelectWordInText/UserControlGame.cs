...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SelectWordInText {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVfullscreen_ShowText);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVfullscreen_ShowWordToFind);
            this.stepList.Add(step);
        ...
        private void selectDataset(
            ...
            if (this.selectedDataset != selectedDataset) {
                ...
                if (this.selectedDataset is DatasetContent) {
                    this.selectedDataset.PropertyChanged += this.selectedDataset_PropertyChanged;
                    this.textBoxDatasetRowTargetID.Text = this.selectedDataset.RowTargetID.ToString();
                    this.textBoxDatasetWordTargetID.Text = this.selectedDataset.WordTargetID.ToString();
                }
                else {
                    this.textBoxDatasetRowTargetID.Text = string.Empty;
                    this.textBoxDatasetWordTargetID.Text = string.Empty;
                }
            }
        ...
        void selectedDataset_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.selectedDataset_PropertyChanged(sender, e)));
                ...
                if (e.PropertyName == "RowTargetID") this.textBoxDatasetRowTargetID.Text = this.selectedDataset.RowTargetID.ToString();
                else if (e.PropertyName == "WordTargetID") this.textBoxDatasetWordTargetID.Text = this.selectedDataset.WordTargetID.ToString();
            }
        }
        ...
        private void buttonVfullscreen_ShowText_Click(object sender, EventArgs e) { this.business.Vfullscreen_ShowText(); }
        private void buttonVfullscreen_ShowWordToFind_Click(object sender, EventArgs e) { this.business.Vfullscreen_TextInsertIn(); }
