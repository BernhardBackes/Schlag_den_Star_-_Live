...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SelectWordInText {
    ...
    public class DatasetContent : Cliparts.Messaging.Message, INotifyPropertyChanged {
        ...
        private string coverFilename = string.Empty;
        public string CoverFilename {
            get { return this.coverFilename; }
            set {
                if (this.coverFilename != value) {
                    if (value == null) value = string.Empty;
                    this.coverFilename = value;
                    this.on_PropertyChanged();
                    this.Cover = Helper.getThumbnailFromMediaFile(value, 1.0f);
                }
            }
        }
        ...
        public string WordToFind {
            get { return this.wordToFind; }
            set {
                if (this.wordToFind != value) {
                    if (value == null) value = string.Empty;
        ...
        private int rowTargetID = 0;
        public int RowTargetID {
            get { return this.rowTargetID; }
            set {
                if (this.rowTargetID != value) {
                    this.rowTargetID = value;
                    this.on_PropertyChanged();
                }
            }
        }

        private int wordTargetID = 0;
        public int WordTargetID {
            get { return this.wordTargetID; }
            set {
                if (this.wordTargetID != value) {
                    this.wordTargetID = value;
                    this.on_PropertyChanged();
                }
            }
        }
        ...
        public DatasetContent(
            ...
            if (string.IsNullOrEmpty(pictureFilename)) {
                this.Name = "?";
                this.CoverFilename = string.Empty;
            }
            else {
                this.Name = Path.GetFileNameWithoutExtension(pictureFilename);
                this.CoverFilename = pictureFilename;
            }
        }
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.SelectWordInText'", typeIdentifier);
        }
        ...
        public void Vfullscreen_SetContent(
            ...
            if (scene is Fullscreen) {
                scene.SetCoverFilename(coverFilename);
                scene.SetText(text);
                scene.SetRowTargetID(rowTargetID);
                scene.SetWordTargetID(wordTargetID);
            }
        }
        public void Vfullscreen_ContentIn() {
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene &&
                ...
                this.Vfullscreen_SetContent(
                    ...
                    this.SelectedDataset.CoverFilename,
                    this.SelectedDataset.Text,
                    this.SelectedDataset.RowTargetID,
                    this.SelectedDataset.WordTargetID);
                this.fullscreenScene.TextInsert.SetOut();
                this.fullscreenScene.ToIn();
            }
        }
        public void Vfullscreen_ShowText() { if (this.fullscreenScene is VRemote4.HandlerSi.Scene) this.fullscreenScene.TextToIn(); }
        public void Vfullscreen_Resolve() { if (this.fullscreenScene is VRemote4.HandlerSi.Scene) this.fullscreenScene.StartTextSelection(); }
        public void Vfullscreen_SetTextInsert() { if (this.fullscreenScene is VRemote4.HandlerSi.Scene && this.SelectedDataset is DatasetContent) this.Vfullscreen_SetTextInsert(this.fullscreenScene.TextInsert, this.SelectedDataset.WordToFind); }
        ...
        public void Vfullscreen_TextInsertIn() {
            this.Vfullscreen_SetTextInsert();
        ...
        public void Vhost_Set() {
            if (this.hostScene is VRemote4.HandlerSi.Scene &&
                this.SelectedDataset is DatasetContent) Vhost_Set(this.hostScene, this.SelectedDataset.WordToFind);
        }
        public void Vhost_Set(
            Host scene,
            string word) {
            if (scene is Host) scene.SetWord(word);
        }
        public void Vhost_Out() { if (this.hostScene is VRemote4.HandlerSi.Scene) this.hostScene.ToOut(); }
