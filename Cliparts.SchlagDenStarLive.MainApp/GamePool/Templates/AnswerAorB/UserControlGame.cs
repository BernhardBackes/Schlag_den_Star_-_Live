...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.AnswerAorB {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        private void setComboBoxPlayerInputItems() {
            ...
            this.comboBoxLeftPlayerInput.Items.Add(string.Empty);
            this.comboBoxLeftPlayerInput.Items.Add(this.business.AnswerA);
            this.comboBoxLeftPlayerInput.Items.Add(this.business.AnswerB);
            this.comboBoxLeftPlayerInput.EndUpdate();

            this.comboBoxRightPlayerInput.BeginUpdate();
            this.comboBoxRightPlayerInput.Items.Add(string.Empty);
            this.comboBoxRightPlayerInput.Items.Add(this.business.AnswerA);
            this.comboBoxRightPlayerInput.Items.Add(this.business.AnswerB);
        ...
        private void setComboBoxLeftPlayerInputText() {
            switch (this.business.LeftPlayerInput) {
                case SelectionStates.AnswerA:
                    this.comboBoxLeftPlayerInput.Text = this.business.AnswerA;
                    break;
                case SelectionStates.AnswerB:
                    this.comboBoxLeftPlayerInput.Text = this.business.AnswerB;
                    break;
                case SelectionStates.NotAvailable:
                default:
                    this.comboBoxLeftPlayerInput.Text = string.Empty;
                    break;
            }
        }

        private void setComboBoxRightPlayerInputText() {
            switch (this.business.RightPlayerInput) {
                case SelectionStates.AnswerA:
                    this.comboBoxRightPlayerInput.Text = this.business.AnswerA;
                    break;
                case SelectionStates.AnswerB:
                    this.comboBoxRightPlayerInput.Text = this.business.AnswerB;
                    break;
                case SelectionStates.NotAvailable:
                default:
                    this.comboBoxRightPlayerInput.Text = string.Empty;
                    break;
            }
        }
            ...
            if (this.selectedDataset is DatasetContent) {
                switch (this.selectedDataset.Solution) {
                    case SolutionStates.AnswerA:
                        this.textBoxSolution.Text = this.business.AnswerA;
                        break;
                    case SolutionStates.AnswerB:
                        this.textBoxSolution.Text = this.business.AnswerB;
                        break;
                }
            }
            else this.textBoxSolution.Text = string.Empty;
        }
        ...
        protected override void business_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            ...
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.business_PropertyChanged(sender, e)));
                ...
                else if (e.PropertyName == "AnswerA") {
                    this.setSolution();
                    this.setComboBoxPlayerInputItems();
                }
                else if (e.PropertyName == "AnswerB") {
                    this.setSolution();
                    this.setComboBoxPlayerInputItems();
                }
        ...
        void selectedDataset_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.selectedDataset_PropertyChanged(sender, e)));
                ...
                if (e.PropertyName == "Solution") this.setSolution();
            }
        }
        ...
        private void comboBoxLeftPlayerInput_SelectedIndexChanged(object sender, EventArgs e) {
            this.business.LeftPlayerInput = (SelectionStates)this.comboBoxLeftPlayerInput.SelectedIndex;
        }
        ...
        private void comboBoxRightPlayerInput_SelectedIndexChanged(object sender, EventArgs e) {
            this.business.RightPlayerInput = (SelectionStates)this.comboBoxRightPlayerInput.SelectedIndex;
        }
