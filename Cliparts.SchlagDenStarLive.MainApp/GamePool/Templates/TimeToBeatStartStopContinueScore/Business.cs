...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TimeToBeatStartStopContinueScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimeToBeatStartStopContinueScore {
    ...
    public class Business : _Base.Score.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TimeToBeatStartStopContinueScore'", typeIdentifier);
        }
        ...
        public void NextPlayer() {
            if (this.insertScene is VRemote4.HandlerSi.Scene &&
                this.insertScene.TimeToBeat.CurrentTime > 0) {
        ...
        public void Vinsert_StartTimeToBeat() {
            if (this.insertScene is VRemote4.HandlerSi.Scene) {
                this.insertScene.TimeToBeat.ContinueTimer();
        ...
        public void Vinsert_PlaySound_Bad() { if (this.insertScene is VRemote4.HandlerSi.Scene) this.insertScene.PlaySound_Bad(); }
        ...
        protected virtual void sync_timeToBeat_PropertyChanged(object content) {
            ...
            if (e is PropertyChangedEventArgs) {
                ...
                if (this.timeToBeat.HasValue &&
                    this.timeToBeat.Value > 0 &&
                    this.timeToBeat.Value < this.TimeToBeatCurrentTime &&
                    !this.gameLost) {
                    this.Vinsert_PlaySound_Bad();
                    this.gameLost = true;
                }
            }
        }
