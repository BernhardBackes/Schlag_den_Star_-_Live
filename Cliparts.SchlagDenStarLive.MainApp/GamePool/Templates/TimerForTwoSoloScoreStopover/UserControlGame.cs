...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerForTwoSoloScoreStopover {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        private void buttonLeftPlayerFinish_Click(object sender, EventArgs e) { this.business.FirstFinisher = Content.Gameboard.PlayerSelection.LeftPlayer; }
        ...
        private void buttonRightPlayerFinish_Click(object sender, EventArgs e) { this.business.FirstFinisher = Content.Gameboard.PlayerSelection.RightPlayer; }
