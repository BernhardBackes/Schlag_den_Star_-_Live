...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.NumericInputCloserToValue;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.NumericInputCloserToValue {
    ...
    public class Business : _Base.Score.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.NumericInputCloserToValue'", typeIdentifier);
        }
        ...
        private void calcOffsets() {
            if (this.SelectedDataset is DatasetContent &&
                ...
                if (this.LeftPlayerOffset > 0) this.LeftPlayerOffsetText = "+" + this.LeftPlayerOffset.ToString() + this.SelectedDataset.Unit;
                else if (this.LeftPlayerOffset < 0) this.LeftPlayerOffsetText = this.LeftPlayerOffset.ToString() + this.SelectedDataset.Unit;
            ...
            if (this.SelectedDataset is DatasetContent &&
                ...
                if (this.RightPlayerOffset > 0) this.RightPlayerOffsetText = "+" + this.RightPlayerOffset.ToString() + this.SelectedDataset.Unit;
                else if (this.RightPlayerOffset < 0) this.RightPlayerOffsetText = this.RightPlayerOffset.ToString() + this.SelectedDataset.Unit;
        ...
        internal void Vinsert_SetTextInsert() {
            if (this.InsertSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.SelectedDataset is DatasetContent) this.Vinsert_SetTextInsert(this.insertScene, this.SelectedDataset.Name);
        }
        ...
        internal void Vinsert_SetInputInsert(
            ...
            if (scene is Insert) {
                ...
                string value = string.Format("{0}{1}", leftPlayerValue.ToString(), unit);
                ...
                value = string.Format("{0}{1}", rightPlayerValue.ToString(), unit);
        ...
        public void Vfullscreen_SetContent(
            Fullscreen scene,
            string filename) {
            if (scene is Fullscreen) scene.SetMovieFilename(filename);
        }
        internal void Vfullscreen_PlaySolution() {
