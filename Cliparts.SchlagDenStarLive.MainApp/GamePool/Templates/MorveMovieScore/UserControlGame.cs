...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.MorveMovieScore {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            step.AddButton(this.buttonVplayers_ShowContent);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonVplayers_ShowContent_1);
            this.stepList.Add(step);
        ...
        private void buttonTrueSingle_Click(object sender, EventArgs e) { this.business.TrueSingle(); }
        private void buttonFalseSingle_Click(object sender, EventArgs e) { this.business.FalseSingle(); }
        ...
        private void buttonVfullscreen_ContentIn_Click(object sender, EventArgs e) {
            this.business.Vfullscreen_TextInsertOut();
            this.business.Vfullscreen_ContentIn(); 
        }
        private void buttonVfullscreen_Start_Click(object sender, EventArgs e) { this.business.Vfullscreen_Start(); }
        private void buttonVfullscreen_Resolve_Click(object sender, EventArgs e) { this.business.Vfullscreen_Resolve(Business.SelectedItem.Both); }
        private void buttonVfullscreen_ResolveLeft_Click(object sender, EventArgs e) { this.business.Vfullscreen_Resolve(Business.SelectedItem.Left); }
        private void buttonVfullscreen_ResolveRight_Click(object sender, EventArgs e) { this.business.Vfullscreen_Resolve(Business.SelectedItem.Right); }

        private void buttonVfullscreen_ContentOut_Click(object sender, EventArgs e) { 
        ...
        private void buttonVplayers_ShowContent_Click(object sender, EventArgs e) { this.business.Vplayers_ContentIn(); }
        private void buttonVplayers_ShowContent_1_Click(object sender, EventArgs e) { this.business.Vplayers_ContentIn(); }
