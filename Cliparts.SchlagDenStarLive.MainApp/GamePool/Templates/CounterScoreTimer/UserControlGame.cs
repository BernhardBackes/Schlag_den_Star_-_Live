...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.CounterScoreTimer {
    ...
    public partial class UserControlGame : _Base.CounterScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_CounterScoreIn);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonVinsert_SetCounterScore);
            this.stepList.Add(step);
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_CounterScoreOut);
            this.stepList.Add(step);
        ...
        protected virtual void buttonVinsert_SetCounterScore_1_Click(object sender, EventArgs e) { this.business.Vinsert_SetCounterScore(); }
