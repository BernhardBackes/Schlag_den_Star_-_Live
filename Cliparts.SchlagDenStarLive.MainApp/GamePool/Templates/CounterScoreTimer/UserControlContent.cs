...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.CounterScoreTimer {
    ...
    public partial class UserControlContent : _Base.CounterScore.UserControlContent {

        #region Properties

        private Business business;

        private bool previewSceneIsAvailable { get { return this.previewScene is VentuzScenes.GamePool.CounterScoreTimer.Insert && this.previewScene.Status == VRemote4.HandlerSi.Scene.States.Available; } }
        ...
        public override void SetPreviewPipe(
            VRemote4.HandlerSi.Client.Pipe.Business previewPipe) {
            bool selected = ((VentuzScenes.GamePool.CounterScoreTimer.Insert)this.previewScene) is VRemote4.HandlerSi.Scene;
        ...
        public override void Select() {
            if (this.previewPipe is VRemote4.HandlerSi.Client.Pipe.Business &&
                ...
                base.select(new VentuzScenes.GamePool.CounterScoreTimer.Insert(WindowsFormsSynchronizationContext.Current, this.previewPipe));
            }
        }

        protected override void setCounterScorePreview() {
            if (this.previewSceneIsAvailable) {
                VentuzScenes.GamePool.CounterScoreTimer.Insert previewScene = this.previewScene as VentuzScenes.GamePool.CounterScoreTimer.Insert;
                previewScene.CounterScore.SetPositionX(this.business.CounterScorePositionX);
                previewScene.CounterScore.SetPositionY(this.business.CounterScorePositionY);
                previewScene.CounterScore.SetStyle(this.business.CounterScoreStyle);
                previewScene.CounterScore.SetTopName(this.business.LeftPlayerName);
                previewScene.CounterScore.SetTopScore(2);
                previewScene.CounterScore.SetTopCounter(22);
                previewScene.CounterScore.SetBottomName(this.business.RightPlayerName);
                previewScene.CounterScore.SetBottomScore(3);
                previewScene.CounterScore.SetBottomCounter(33);
                previewScene.CounterScore.SetIn();
            }
        }
