...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.CounterScoreTimer;

namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.CounterScoreTimer {
    ...
    public class Business : _Base.CounterScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.CounterScoreTimer'", typeIdentifier);
        }
        ...
        public override void Vinsert_CounterScoreIn() {
            this.Vinsert_SetCounterScore();
            if (this.InsertSceneStatus == VRemote4.HandlerSi.Scene.States.Available) this.insertScene.CounterScore.ToIn();
        }
        public override void Vinsert_SetCounterScore() {
            if (this.InsertSceneStatus == VRemote4.HandlerSi.Scene.States.Available) {
                this.insertScene.CounterScore.SetPositionX(this.CounterScorePositionX);
                this.insertScene.CounterScore.SetPositionY(this.CounterScorePositionY);
                this.insertScene.CounterScore.SetFlipPosition(this.CounterFlipPlayers);
                this.insertScene.CounterScore.SetStyle(this.CounterScoreStyle);
                this.insertScene.CounterScore.SetTopName(this.LeftPlayerName);
                this.insertScene.CounterScore.SetTopScore(this.LeftPlayerScore);
                this.insertScene.CounterScore.SetTopCounter(this.LeftPlayerCounter);
                this.insertScene.CounterScore.SetTopCounterIsVisible(this.LeftPlayerCounterIsVisible);
                this.insertScene.CounterScore.SetBottomName(this.RightPlayerName);
                this.insertScene.CounterScore.SetBottomScore(this.RightPlayerScore);
                this.insertScene.CounterScore.SetBottomCounter(this.RightPlayerCounter);
                this.insertScene.CounterScore.SetBottomCounterIsVisible(this.RightPlayerCounterIsVisible);
            }
        }
        public override void Vinsert_SetCounterIsVisible() {
            if (this.InsertSceneStatus == VRemote4.HandlerSi.Scene.States.Available) {
                this.insertScene.CounterScore.SetTopCounterIsVisible(this.LeftPlayerCounterIsVisible);
                this.insertScene.CounterScore.SetBottomCounterIsVisible(this.RightPlayerCounterIsVisible);
            }
        }
        public override void Vinsert_CounterScoreOut() {
            if (this.InsertSceneStatus == VRemote4.HandlerSi.Scene.States.Available) this.insertScene.CounterScore.ToOut();
        }
