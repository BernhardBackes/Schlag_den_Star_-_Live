...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.ContactMidiTimeToBeatScore {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex);
            step.AddButton(this.buttonGame_ReleaseBuzzer_01);
            this.stepList.Add(step);
        ...
        private void buttonBuzzerLeft_Click(object sender, EventArgs e) { this.business.Fail(Content.Gameboard.PlayerSelection.LeftPlayer); }
        private void buttonBuzzerRight_Click(object sender, EventArgs e) { this.business.Fail(Content.Gameboard.PlayerSelection.RightPlayer); }
        private void buttonFinish_Click(object sender, EventArgs e) { this.business.Finish(); }
        ...
        private void buttonSportIconsIn_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsIn(); }
        private void buttonSportIconsInOut_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsOut(); }
        private void buttonSportIconsSoccerColor_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsSoccer(VentuzScenes.GamePool._Modules.SportIcons.States.Out); }
        private void buttonSportIconsSoccerGray_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsSoccer(VentuzScenes.GamePool._Modules.SportIcons.States.In); }
        private void buttonSportIconsCanColor_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsCan(VentuzScenes.GamePool._Modules.SportIcons.States.Out); }
        private void buttonSportIconsCanGray_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsCan(VentuzScenes.GamePool._Modules.SportIcons.States.In); }
        private void buttonSportIconsHockeyColor_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsHockey(VentuzScenes.GamePool._Modules.SportIcons.States.Out); }
        private void buttonSportIconsHockeyGray_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsHockey(VentuzScenes.GamePool._Modules.SportIcons.States.In); }
        private void buttonSportIconsBasketballColor_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsBasketball(VentuzScenes.GamePool._Modules.SportIcons.States.Out); }
        private void buttonSportIconsBasketballGray_Click(object sender, EventArgs e) { this.business.Vinsert_SportIconsBasketball(VentuzScenes.GamePool._Modules.SportIcons.States.In); }
        ...
        private void buttonGame_ReleaseBuzzer_01_Click(object sender, EventArgs e) { this.business.ReleaseBuzzer(); }
