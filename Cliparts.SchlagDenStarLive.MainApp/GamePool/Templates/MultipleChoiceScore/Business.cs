...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.MultipleChoiceScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.MultipleChoiceScore {
    ...
    public class DatasetContent : Messaging.Message, INotifyPropertyChanged {
        ...
        private Game.AnswerItems solution;
        public Game.AnswerItems Solution {
        ...
        public string AnswerA {
            ...
            set {
                if (this.answerA != value) {
                    ...
                    else this.answerA = Regex.Replace(value, "(?<!\r)\n", "\r\n");
                    this.on_PropertyChanged();
                }
            }
        }
        ...
        public string AnswerB {
            ...
            set {
                if (this.answerB != value) {
                    ...
                    else this.answerB = Regex.Replace(value, "(?<!\r)\n", "\r\n");
                    this.on_PropertyChanged();
                }
            }
        }
        ...
        public string AnswerC{
            ...
            set {
                if (this.answerC!= value) {
                    ...
                    else this.answerC= Regex.Replace(value, "(?<!\r)\n", "\r\n");
                    this.on_PropertyChanged();
                }
            }
        }
    ...
    public class Business : _Base.Score.Business {
        ...
        private Host.SelectionItems leftPlayerInput;
        [XmlIgnore]
        public Host.SelectionItems LeftPlayerInput {
            get { return this.leftPlayerInput; }
            set {
                if (this.leftPlayerInput != value) {
                    this.leftPlayerInput = value;
                    if (this.BuzzerMode && value != Host.SelectionItems.NA) this.doBuzzer(PlayerSelection.LeftPlayer);
                    this.on_PropertyChanged();
        ...
        private Host.SelectionItems rightPlayerInput;
        [XmlIgnore]
        public Host.SelectionItems RightPlayerInput {
            get { return this.rightPlayerInput; }
            set {
                if (this.rightPlayerInput != value) {
                    this.rightPlayerInput = value;
                    if (this.BuzzerMode && value != Host.SelectionItems.NA) this.doBuzzer(PlayerSelection.RightPlayer);
                    this.on_PropertyChanged();
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.MultipleChoiceScore'", typeIdentifier);
        }
        ...
        public override void ResetData() {
            ...
            this.TaskCounter = 0;
            this.SelectDataset(0);
            this.LeftPlayerInput = Host.SelectionItems.NA;
            this.RightPlayerInput = Host.SelectionItems.NA;
        ...
        private void rateLeftPlayerInput() {
            if (this.SelectedDataset is DatasetContent) this.LeftPlayerCorrectInput = this.SelectedDataset.Solution.ToString().Equals(this.LeftPlayerInput.ToString());
            else this.LeftPlayerCorrectInput = false;
        }

        private void rateRightPlayerInput() {
            if (this.SelectedDataset is DatasetContent) this.RightPlayerCorrectInput = this.SelectedDataset.Solution.ToString().Equals(this.RightPlayerInput.ToString());
        ...
        private void doBuzzer(
            ...
            switch (buzzeredPlayer) {
                case PlayerSelection.LeftPlayer:
                    if (this.RightPlayerInput == Host.SelectionItems.NA) {
                ...
                case PlayerSelection.RightPlayer:
                    if (this.LeftPlayerInput == Host.SelectionItems.NA) {
                        this.Vleftplayer_ResetInput();
                    }
                    else {
                        this.Vrightplayer_ResetInput();
        ...
        public void Vinsert_SetGame(
            ...
            if (scene is Game) {
                ...
                if (dataset is DatasetContent) {
                    ...
                    scene.SetAnswerAText(dataset.AnswerA);
                    scene.SetAnswerBText(dataset.AnswerB);
                    scene.SetAnswerCText(dataset.AnswerC);
                    scene.SetAnswersSolution(dataset.Solution);
                }
                else {
                    ...
                    scene.SetAnswersSolution(Game.AnswerItems.AnswerA);
                }
            }
        }
        internal void Vinsert_AnswersIn() {
            if (this.insertScene is Insert &&
                this.insertScene.Game is Game) {
                this.insertScene.Game.AnswersToIn();
            }
        }
        public void Vinsert_InputIn() {
        ...
        public void Vinsert_GameInputIn(
            Game scene) {
            if (scene is Game) scene.AnswersToInputIn();
        }
        ...
        internal void Vinsert_SetGameInput(
            Game scene,
            Host.SelectionItems leftPlayerSelection,
            Host.SelectionItems rightPlayerSelection) {
            if (scene is Game) { 
                scene.SetLeftPlayerInput(leftPlayerSelection);
                scene.SetRightPlayerInput(rightPlayerSelection);
            }
        }
        public void Vinsert_Resolve() {
            this.Vinsert_SetGame();
            if (this.insertScene is Insert) this.insertScene.Game.AnswersToSolutionIn(); 
        }
        ...
        public void Vplayer_SetData(
            ...
            if (scene is Player &&
                ...
                scene.SetAnswerA(dataset.AnswerA);
                scene.SetAnswerB(dataset.AnswerB);
                scene.SetAnswerC(dataset.AnswerC);
                scene.SetText(dataset.Text);
            }
        }
        public void Vplayer_ResetInput(Player scene) {
            if (scene is Player) scene.ResetAnswer();
        }
        public void Vplayer_SetInput(
            Player scene,
            Host.SelectionItems selection) {
            if (scene is Player) {
                //switch (selection) {
        ...
        private void sync_leftPlayerScene_PropertyChanged(object content) {
            ...
            if (e is PropertyChangedEventArgs) {
                if (e.PropertyName == "Input") {
                    this.LeftPlayerInput = this.leftPlayerScene.Input;
                    this.Vhost_Set();
                }
            }
        }
        ...
        private void sync_rightPlayerScene_PropertyChanged(object content) {
            ...
            if (e is PropertyChangedEventArgs) {
                if (e.PropertyName == "Input") {
                    this.RightPlayerInput = this.rightPlayerScene.Input;
                    this.Vhost_Set();
                }
            }
        }
