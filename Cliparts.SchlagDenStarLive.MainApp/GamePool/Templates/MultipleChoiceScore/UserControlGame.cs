...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.MultipleChoiceScore {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        public UserControlGame() {
            ...
            this.comboBoxLeftPlayerInput.Items.AddRange(Enum.GetNames(typeof(Host.SelectionItems)));
            this.comboBoxLeftPlayerInput.EndUpdate();

            this.comboBoxRightPlayerInput.BeginUpdate();
            this.comboBoxRightPlayerInput.Items.AddRange(Enum.GetNames(typeof(Host.SelectionItems)));
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_AnswersIn);
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ShowInput);
        ...
        private void setSolution() {
            if (this.selectedDataset is DatasetContent) this.textBoxSolution.Text = this.selectedDataset.Solution.ToString();
        ...
        private void comboBoxLeftPlayerInput_SelectedIndexChanged(object sender, EventArgs e) {
            Host.SelectionItems result;
            if (Enum.TryParse(this.comboBoxLeftPlayerInput.Text, out result)) this.business.LeftPlayerInput = result;
        }
        ...
        private void comboBoxRightPlayerInput_SelectedIndexChanged(object sender, EventArgs e) {
            Host.SelectionItems result;
            if (Enum.TryParse(this.comboBoxRightPlayerInput.Text, out result)) this.business.RightPlayerInput = result;
        }
        ...
        private void buttonVinsert_TextIn_Click(object sender, EventArgs e) { this.business.Vinsert_TextIn(); }
        private void buttonVinsert_AnswersIn_Click(object sender, EventArgs e) { this.business.Vinsert_AnswersIn(); }
        private void buttonVinsert_SetInput_Click(object sender, EventArgs e) { this.business.Vinsert_InputIn(); }
