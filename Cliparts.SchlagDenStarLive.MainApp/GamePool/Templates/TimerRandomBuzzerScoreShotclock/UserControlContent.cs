...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerRandomBuzzerScoreShotclock {
    ...
    public partial class UserControlContent : _Base.Timer.UserControlContent {
        ...
        public void Pose(
            ...
            bind = new Binding("BackColor", this.business, "ScoreColor");
            bind.Format += (s, e) => { e.Value = (Color)e.Value; };
            this.labelScoreColor.DataBindings.Add(bind);
            bind = new Binding("ForeColor", this.business, "OffColor");
            bind.Format += (s, e) => { e.Value = (Color)e.Value; };
            this.labelScoreColor.DataBindings.Add(bind);

            bind = new Binding("BackColor", this.business, "TimeoutColor");
            bind.Format += (s, e) => { e.Value = (Color)e.Value; };
            this.labelTimeoutColor.DataBindings.Add(bind);
            bind = new Binding("ForeColor", this.business, "OffColor");
            bind.Format += (s, e) => { e.Value = (Color)e.Value; };
            this.labelTimeoutColor.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.labelScoreColor.DataBindings.Clear();
            this.labelTimeoutColor.DataBindings.Clear();
        ...
        private void labelScoreColor_Click(object sender, EventArgs e) {
            ColorDialog dialog = new ColorDialog();
            dialog.Color = this.business.ScoreColor;
            switch (dialog.ShowDialog()) {
                case DialogResult.OK:
                    this.business.ScoreColor = dialog.Color;
                    break;
            }
        }

        private void labelTimeoutColor_Click(object sender, EventArgs e) {
            ColorDialog dialog = new ColorDialog();
            dialog.Color = this.business.TimeoutColor;
            switch (dialog.ShowDialog()) {
                case DialogResult.OK:
                    this.business.TimeoutColor = dialog.Color;
                    break;
            }
        }
