...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TextInsertTeamInputScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TextInsertTeamInputScore {
    ...
    public class Business : _Base.Score.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TextInsertTeamInputScore'", typeIdentifier);
        }
