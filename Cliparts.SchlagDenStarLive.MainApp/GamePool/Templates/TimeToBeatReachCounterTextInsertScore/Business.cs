...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimeToBeatReachCounterTextInsertScore {
    ...
    public class Business : _Base.Score.Business {
        ...
        private int toReachValue = 0;
        public int ToReachValue {
            get { return this.toReachValue; }
            set {
                if (this.toReachValue != value) {
                    this.toReachValue = value;
                    this.on_PropertyChanged();
                }
            }
        }
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TimeToBeatReachCounterTextInsertScore'", typeIdentifier);
        }
        ...
        internal void False() { 
            ...
            this.Vinsert_SetContent();
            this.Vfullscreen_ContentIn();
        }

        internal void True() {            
            this.CounterValue++;
            this.Vinsert_SetTimeToBeatCounter();
            if (this.CounterValue < this.ToReachValue) {
                if (this.insertScene is VRemote4.HandlerSi.Scene) this.insertScene.PlaySound_Hit();
                this.SelectDataset(this.SelectedDatasetIndex + 1);
                this.Vinsert_SetContent();
                this.Vfullscreen_ContentIn();
            }
        ...
        public void Vinsert_SetTimeToBeat() {
            if (this.insertScene is VRemote4.HandlerSi.Scene) {
                ...
                this.insertScene.TimeToBeat.SetCounter(this.CounterValue);
        ...
        public void Vinsert_SetTimeToBeatCounter() {
            if (this.insertScene is VRemote4.HandlerSi.Scene) this.insertScene.TimeToBeat.SetCounter(this.CounterValue);
        }
        ...
        internal void Vfullscreen_ContentIn() {
            ...
            if (this.SelectedDataset is DatasetContent) this.fullscreenMasterScene.Freetext.SetTextValue(this.SelectedDataset.Text);
            else this.fullscreenMasterScene.Freetext.SetTextValue("?");
        }
        internal void Vfullscreen_ContentOut() {
            this.fullscreenMasterScene.Freetext.SetTextValue(string.Empty);
        }
