...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SetLargeScore {
    ...
    public partial class UserControlContent : _Base.SetLarge.UserControlContent {
        ...
        private bool previewSceneIsAvailable { get { return this.previewScene is VentuzScenes.GamePool.SetLargeScore.Insert && this.previewScene.Status == VRemote4.HandlerSi.Scene.States.Available; } }
        ...
        public override void SetPreviewPipe(
            VRemote4.HandlerSi.Client.Pipe.Business previewPipe) {
            bool selected = ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene) is VRemote4.HandlerSi.Scene;
        ...
        public override void Select() {
            if (this.previewPipe is VRemote4.HandlerSi.Client.Pipe.Business &&
                ...
                base.select(new VentuzScenes.GamePool.SetLargeScore.Insert(WindowsFormsSynchronizationContext.Current, this.previewPipe));
            }
        }

        protected override void setSetLargePreview() {
            if (this.previewSceneIsAvailable) {
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).SetLarge.SetPositionX(this.business.SetLargePositionX);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).SetLarge.SetPositionY(this.business.SetLargePositionY);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).SetLarge.SetTopName(this.business.LeftPlayerName);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).SetLarge.SetBottomName(this.business.RightPlayerName);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).SetLarge.SetIn();
            }
        }

        protected void setScorePreview() {
            if (this.previewSceneIsAvailable) {
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).Score.SetPositionX(this.business.ScorePositionX);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).Score.SetPositionY(this.business.ScorePositionY);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).Score.SetStyle(this.business.ScoreStyle);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).Score.SetLeftTopName(this.business.LeftPlayerName);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).Score.SetLeftTopScore(this.business.LeftPlayerScore);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).Score.SetRightBottomName(this.business.RightPlayerName);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).Score.SetRightBottomScore(this.business.RightPlayerScore);
                ((VentuzScenes.GamePool.SetLargeScore.Insert)this.previewScene).Score.SetIn();
            }
        }
