...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TwoPicturesFade;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TwoPicturesFade {
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TwoPicturesFade'", typeIdentifier);
        }
        ...
        public void Vhost_In() {
            if (this.hostScene is VRemote4.HandlerSi.Scene) {
                if (this.SelectedDataset is DatasetContent) this.Vhost_Set(this.hostScene, this.SelectedDataset.Name);
                else this.Vhost_Set(this.hostScene, string.Empty);
                this.hostScene.ToIn();
            }
        }
