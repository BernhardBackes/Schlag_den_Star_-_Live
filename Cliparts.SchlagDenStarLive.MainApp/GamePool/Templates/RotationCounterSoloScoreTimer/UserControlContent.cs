...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.RotationCounterSoloScoreTimer {
    ...
    public partial class UserControlContent : _Base.Score.UserControlContent {
        ...
        public void Pose(
            ...
            this.comboBoxLeftPlayerIOUnit.DataBindings.Add(bind);
            ...
            bind.Format += (s, e) => { e.Value = (string)e.Value; };
            this.comboBoxRightPlayerIOUnit.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.comboBoxLeftPlayerIOUnit.DataBindings.Clear();
            this.comboBoxRightPlayerIOUnit.DataBindings.Clear();
        ...
        private void fillIOUnitList() {
            this.comboBoxLeftPlayerIOUnit.BeginUpdate();
            this.comboBoxLeftPlayerIOUnit.Items.Clear();
            this.comboBoxLeftPlayerIOUnit.Items.AddRange(this.business.IOUnitNameList);
            this.comboBoxLeftPlayerIOUnit.EndUpdate();
            this.comboBoxRightPlayerIOUnit.BeginUpdate();
            this.comboBoxRightPlayerIOUnit.Items.Clear();
            this.comboBoxRightPlayerIOUnit.Items.AddRange(this.business.IOUnitNameList);
            this.comboBoxRightPlayerIOUnit.EndUpdate();
        }
        ...
        protected virtual void comboBoxLeftPlayerIOUnit_TextChanged(object sender, EventArgs e) { if (this.business is Business) this.business.LeftPlayerIOUnitName = this.comboBoxLeftPlayerIOUnit.Text; }
        protected virtual void comboBoxRightPlayerIOUnit_TextChanged(object sender, EventArgs e) { if (this.business is Business) this.business.RightPlayerIOUnitName = this.comboBoxRightPlayerIOUnit.Text; }
