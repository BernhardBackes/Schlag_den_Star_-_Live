...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TextInsertSoloScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TextInsertSoloScore {
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TextInsertSoloScore'", typeIdentifier);
        }
