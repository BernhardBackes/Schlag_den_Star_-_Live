...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.LettersCount {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_StartTextAnimation);
            this.stepList.Add(step);
        ...
        void selectedDataset_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.selectedDataset_PropertyChanged(sender, e)));
                ...
                if (e.PropertyName == "LettersCount") this.textBoxDataSetLettersCount.Text = this.selectedDataset.LettersCount.ToString();
            }
        }
        ...
        private void buttonVinsert_StartTextAnimation_Click(object sender, EventArgs e) { this.business.Vinsert_StartTextAnimation(); }
