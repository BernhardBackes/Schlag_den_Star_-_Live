...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TextInsertTeamInputListScore {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            step.AddButton(this.buttonGame_NextInput);
            this.stepList.Add(step);
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVstage_ContentIn_1);
            step.AddButton(this.buttonVinsert_TaskIn_1);
            step.AddButton(this.buttonVhost_SetInput_1);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_ContentOut_1);
            step.AddButton(this.buttonVstage_ContentOut_1);
            this.stepList.Add(step);
        ...
        private void selectDataset(
            ...
            if (this.selectedDataset != selectedDataset) {
                //Dispose...
                this.textBoxDatasetInfo.Text = string.Empty;
                ...
                if (this.selectedDataset is DatasetContent) {
                    this.selectedDataset.PropertyChanged += this.selectedDataset_PropertyChanged;
                    this.textBoxDatasetInfo.Text = this.selectedDataset.InfoText;
                }
            }
        ...
        void selectedDataset_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.selectedDataset_PropertyChanged(sender, e)));
                ...
                if (e.PropertyName == "InfoText") this.textBoxDatasetInfo.Text = this.selectedDataset.InfoText;
            }
        }
        ...
        private void textBoxDatasetInfo_TextChanged(object sender, EventArgs e) { this.textBoxDatasetInfo.Visible = !string.IsNullOrWhiteSpace(this.textBoxDatasetInfo.Text); }
        ...
        private void buttonVinsert_TaskIn_1_Click(object sender, EventArgs e) { this.business.Vinsert_TaskIn(); }
        ...
        private void buttonVinsert_ContentOut_1_Click(object sender, EventArgs e) { this.business.Vinsert_ContentOut(); }
        ...
        private void buttonVstage_ContentIn_1_Click(object sender, EventArgs e) { this.business.Vstage_ContentIn(); }
        private void buttonVstage_ContentOut_1_Click(object sender, EventArgs e) { this.business.Vstage_ContentOut(); }

        private void buttonVhost_SetInput_Click(object sender, EventArgs e) { this.business.Vhost_SetContent(); }
        private void buttonVhost_SetInput_1_Click(object sender, EventArgs e) { this.business.Vhost_SetContent(); }
        ...
        private void buttonGame_NextInput_Click(object sender, EventArgs e) { this.business.NextInput(); }
