...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.WindingQuizPictures {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            step.AddButton(this.buttonVfullscreen_NextItem);
            ...
            step.AddButton(this.buttonVfullscreen_NextItem_1);
        ...
        private void setSelectedDataItem() {
            if (this.business.SelectedDataItem is DataItem) this.pictureBoxDataItemPicture.Image = this.business.SelectedDataItem.Picture;
            else this.pictureBoxDataItemPicture.Image = null;
        }
        ...
        void selectedDataset_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.selectedDataset_PropertyChanged(sender, e)));
                ...
                //if (e.PropertyName == "PictureFilename") this.pictureBoxDataItemPicture.Image = this.selectedDataset.Solution;
            }
        }
        ...
        private void buttonVfullscreen_NextItem_Click(object sender, EventArgs e) { this.business.Vfullscreen_NextItem(); }
        private void buttonVfullscreen_NextItem_1_Click(object sender, EventArgs e) { this.business.Vfullscreen_NextItem(); }
