...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.InsertStillAndMovieBuzzerScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.InsertStillAndMovieBuzzerScore {
        ...
        public string MovieFilename {
            ...
            set {
                if (this.movieFilename != value) {
                    ...
                    this.Movie = Helper.getThumbnailFromMediaFile(value, 1.0f);
                }
            }
        }
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.InsertStillAndMovieBuzzerScore'", typeIdentifier);
        }
        ...
        internal void Vinsert_TableIn() { if (this.insertScene is VRemote4.HandlerSi.Scene) this.insertScene.StillToIn(); }
        internal void Vinsert_TableOut() { if (this.insertScene is VRemote4.HandlerSi.Scene) this.insertScene.StillToOut(); }
        ...
        public void Vinsert_ContentIn() {
            if (this.insertScene is VRemote4.HandlerSi.Scene &&
                ...
                this.Vinsert_SetContent(this.insertScene, this.SelectedDataset.Name, this.SelectedDataset.MovieFilename);
                this.insertScene.MovieToIn();
            }
            if (this.TaskCounter > 0 && this.TaskCounter <= this.TaskCounterSize) this.Vinsert_TaskCounterIn();
        }
        public void Vinsert_SetContent() {
            if (this.insertScene is Insert) {
                this.insertScene.SetMoviePositionX(this.ContentPositionX);
                this.insertScene.SetMoviePositionY(this.ContentPositionY);
            }
        }
        public void Vinsert_SetContent(
            Insert scene,
            ...
            if (scene is Insert) {
                scene.SetMoviePositionX(this.ContentPositionX);
                scene.SetMoviePositionY(this.ContentPositionY);
                scene.SetMovieText(movieText);
                scene.SetMovieFilename(movieFilename);
            }
        }
        public void Vinsert_ResolveContent() {
            if (this.insertScene is VRemote4.HandlerSi.Scene) {
                this.insertScene.ResolveMovie();
                //this.insertScene.PlayJingleResolve();
            }
        }
        public void Vinsert_ContentOut() { 
            if (this.insertScene is VRemote4.HandlerSi.Scene) this.insertScene.MovieToOut();
        ...
        internal void Vhost_TableIn() {
            if (this.HostSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.hostScene.Insert is Insert) this.hostScene.Insert.StillToIn();
        }
        public void Vhost_ContentIn() {
            this.Vhost_SetContent();
            if (this.HostSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.hostScene.Insert is Insert) this.hostScene.Insert.MovieToIn();
        }
        public void Vhost_SetContent() { if (this.hostScene is VRemote4.HandlerSi.Scene && this.SelectedDataset is DatasetContent) this.Vhost_SetContent(this.hostScene, this.TaskCounter, this.SelectedDataset.Name, this.SelectedDataset.MovieFilename); }
        public void Vhost_SetContent(
            ...
            if (scene is Host &&
                scene.Insert is Insert) {
                scene.Insert.SetMoviePositionX(this.ContentPositionX);
                scene.Insert.SetMoviePositionY(this.ContentPositionY);
                scene.Insert.SetMovieText(hostText);
                scene.Insert.SetMovieFilename(movieFilename);
                scene.Insert.MovieToLastFrame();
            }
        }
        public void Vhost_ContentOut() {
            if (this.HostSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.hostScene.Insert is Insert) this.hostScene.Insert.MovieToOut();
        }
