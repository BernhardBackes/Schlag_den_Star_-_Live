...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.Correlation {
    ...
    public partial class UserControlGame : _Base.TimerScore.UserControlGame {
        ...
        public void Pose(
            ...
            bind = new Binding("Checked", this.business, "TimerEnabled");
            bind.Format += (s, e) => { e.Value = (bool)e.Value; };
            this.checkBoxTimerEnabled.DataBindings.Add(bind);

            bind = new Binding("ForeColor", this.business, "TimerEnabled");
            bind.Format += (s, e) => { e.Value = (bool)e.Value ? Constants.ColorDisabled : this.ForeColor; };
            this.checkBoxTimerEnabled.DataBindings.Add(bind);

            bind = new Binding("Enabled", this.business, "TimerEnabled");
            bind.Format += (s, e) => { e.Value = (bool)e.Value; };
            this.buttonVinsert_StartTimer.DataBindings.Add(bind);

            this.fillDataList();
            this.selectDataset(this.business.SelectedDataset);

            this.fillListBoxIdleItems();
            this.fillListBoxIdleChoices();
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.checkBoxTimerEnabled.DataBindings.Clear();
            this.buttonVinsert_StartTimer.DataBindings.Clear();
        }
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, this.startTimer);
        ...
        protected int startTimer(
            int stepIndex) {
            if (this.business.TimerEnabled) return stepIndex + 1;
            else return stepIndex + 2;
        }
        protected int checkTrueOrFalse(
            int stepIndex) {
            if (this.business.SelectionStatus == SelectionStates.Idle ||
                this.business.SelectionStatus == SelectionStates.True) {
                if (this.business.TimerEnabled) return stepIndex - 2;
        ...
        private void fillListBoxIdleChoices() {
            this.listBoxIdleChoices.BeginUpdate();
            this.listBoxIdleChoices.Items.Clear();
            this.listBoxIdleChoices.Items.AddRange(this.business.IdleChoices);
        ...
        private void fillListBoxUsedChoices() {
            ...
            this.listBoxUsedChoices.Items.AddRange(this.business.UsedChoices);
        ...
        protected override void business_PropertyChanged(object sender, PropertyChangedEventArgs e) {
            ...
            if (this.InvokeRequired) this.Invoke((MethodInvoker)(() => this.business_PropertyChanged(sender, e)));
                ...
                else if (e.PropertyName == "IdleChoices") {
                    this.fillListBoxIdleChoices();
                    this.setSelectionStatus();
                }
                else if (e.PropertyName == "UsedChoices") this.fillListBoxUsedChoices();
            }
        }
        ...
        private void listBoxIdleItems_SelectedIndexChanged(object sender, EventArgs e) { this.business.SelectItem(this.listBoxIdleItems.SelectedIndex); }
        private void listBoxIdleChoices_SelectedIndexChanged(object sender, EventArgs e) { this.business.SelectChoice(this.listBoxIdleChoices.Text); }

        private void buttonVinsert_StartTimer_EnabledChanged(object sender, EventArgs e) { Helper.setControlBackColor(this.buttonVinsert_StartTimer); }
        private void checkBoxTimerEnabled_CheckedChanged(object sender, EventArgs e) { this.business.TimerEnabled = this.checkBoxTimerEnabled.Checked; }
