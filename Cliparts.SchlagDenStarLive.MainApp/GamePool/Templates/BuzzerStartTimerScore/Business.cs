...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.BuzzerStartTimerScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.BuzzerStartTimerScore {
    ...
    public class Business : _Base.BuzzerStartTimerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.BuzzerStartTimerScore'", typeIdentifier);
        }
        ...
        public override void Pose(
            ...
            this.insertScene.Timer.Alarm1Fired += this.leftTimer_Alarm1Fired;
            this.insertScene.Timer.Alarm2Fired += this.leftTimer_Alarm2Fired;
            this.insertScene.Timer.StopFired += this.leftTimer_StopFired;
            this.insertScene.Timer.PropertyChanged += this.leftTimer_PropertyChanged;
        }
