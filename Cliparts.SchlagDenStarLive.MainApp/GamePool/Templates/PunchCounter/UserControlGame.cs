...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.PunchCounter {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        public void Pose(
            ...
            this.userControlGamePoolTemplatesPunchCounterClient.Pose("punch client", this.business.PunchClient);
            this.userControlGamePoolTemplatesPunchCounterClient.BackColor = this.BackColor;
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.userControlGamePoolTemplatesPunchCounterClient.Dispose();
        }
        ...
        protected override void buildStepList() {
            ...
            step.AddButton(this.buttonGame_ConnectClient);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonGame_StartClient);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonGame_StopClient);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonGame_ResetClient);
            this.stepList.Add(step);
            ...
            step.AddButton(this.buttonVgraphic_Clear);
            step.AddButton(this.buttonVstage_Clear);
            step.AddButton(this.buttonGame_DisconnectClient);
            this.stepList.Add(step);
        ...
        private void buttonVfullscreen_SetCounter_1_Click(object sender, EventArgs e) { this.business.Vfullscreen_SetCounter(); }

        private void buttonGame_ConnectClient_Click(object sender, EventArgs e) { this.business.ConnectClient(); }
        private void buttonGame_StartClient_Click(object sender, EventArgs e) { this.business.StartClient(); }
        private void buttonGame_StopClient_Click(object sender, EventArgs e) { this.business.StopClient(); }
        protected void buttonGame_Next_Click(object sender, EventArgs e) { this.business.Next(); }
        private void buttonGame_ResetClient_Click(object sender, EventArgs e) { this.business.ResetClient(); }
        private void buttonGame_DisconnectClient_Click(object sender, EventArgs e) { this.business.DisconnectClient(); }
