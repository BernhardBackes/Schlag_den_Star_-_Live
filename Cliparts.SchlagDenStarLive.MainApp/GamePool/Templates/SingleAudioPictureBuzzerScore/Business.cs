...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.SingleAudioPictureBuzzerScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SingleAudioPictureBuzzerScore {
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.SingleAudioPictureBuzzerScore'", typeIdentifier);
        }
        ...
        internal void Vinsert_ImageIn() {
            if (this.InsertSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                ...
                this.insertScene.ImageToIn();
            }
        }
        internal void Vinsert_ImageOut() { if (this.InsertSceneStatus == VRemote4.HandlerSi.Scene.States.Available) this.insertScene.ImageToOut(); }
        ...
        internal void Vfullscreen_PauseAudio() { if (this.FullscreenSceneStatus == VRemote4.HandlerSi.Scene.States.Available) this.fullscreenScene.PauseAudio(); }
        ...
        public void Vhost_Set() {
            if (this.HostSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.SelectedDataset is DatasetContent) {
                this.hostScene.SetHostText(this.SelectedDataset.HostText);
            }
        }
