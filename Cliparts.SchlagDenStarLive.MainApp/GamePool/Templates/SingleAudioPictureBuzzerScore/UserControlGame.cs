...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.SingleAudioPictureBuzzerScore {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        private void buttonVinsert_PictureIn_Click(object sender, EventArgs e) { this.business.Vinsert_ImageIn(); }
        ...
        private void buttonVfullscreen_StopAudio_Click(object sender, EventArgs e) { this.business.Vfullscreen_PauseAudio(); }
