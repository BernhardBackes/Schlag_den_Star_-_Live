...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.ScrabbleListCounterScoreTimer {
    ...
    public partial class UserControlGame : _Base.Score.UserControlGame {
        ...
        public UserControlGame() {
            ...
            this.numericUpDownLeftPlayerCounterAddX.Minimum = 0;
            this.numericUpDownLeftPlayerCounterAddX.Maximum = int.MaxValue;

            this.numericUpDownRightPlayerCounter.Minimum = int.MinValue;
            this.numericUpDownRightPlayerCounter.Maximum = int.MaxValue;
            this.numericUpDownRightPlayerCounterAddX.Minimum = 0;
            this.numericUpDownRightPlayerCounterAddX.Maximum = int.MaxValue;
        ...
        protected void UserControlGame_BackColorChanged(object sender, EventArgs e) {
            foreach (Control control in this.Controls) {
                if (control is UserControlGamePoolScrabbleListCounterScoreTimerLetter) control.BackColor = this.BackColor;
            }
        }
        ...
        private void buttonLeftPlayerCounterAddX_Click(object sender, EventArgs e) {
            this.business.LeftPlayerCounter += (int)this.numericUpDownLeftPlayerCounterAddX.Value;
            this.business.Vinsert_SetCounter();
        }
        ...
        private void buttonRightPlayerCounterAddX_Click(object sender, EventArgs e) {
            this.business.RightPlayerCounter += (int)this.numericUpDownRightPlayerCounterAddX.Value;
            this.business.Vinsert_SetCounter();
        }
