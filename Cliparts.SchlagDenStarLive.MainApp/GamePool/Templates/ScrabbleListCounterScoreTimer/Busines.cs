...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.ScrabbleListCounterScoreTimer;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.ScrabbleListCounterScoreTimer {
    ...
    public class Business : _Base.Score.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.ScrabbleListCounterScoreTimer'", typeIdentifier);
        }
