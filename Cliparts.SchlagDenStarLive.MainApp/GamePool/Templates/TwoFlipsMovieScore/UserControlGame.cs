...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TwoFlipsMovieScore {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        protected override void buildStepList() {
            ...
            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVinsert_StopTimeout_1);
            this.stepList.Add(step);

            index++;
            step = new stepAction(index, (stepIndex) => stepIndex + 1);
            step.AddButton(this.buttonVfullscreen_Next);
            this.stepList.Add(step);
        ...
        private void buttonVinsert_StopTimeout_1_Click(object sender, EventArgs e) { this.business.Vinsert_StopTimeout(); }
        ...
        private void buttonVfullscreen_Next_Click(object sender, EventArgs e) { this.business.Vfullscreen_Next(); }
