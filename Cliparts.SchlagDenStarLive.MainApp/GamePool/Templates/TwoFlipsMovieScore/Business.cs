...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TwoFlipsMovieScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TwoFlipsMovieScore {
        ...
        public string MovieFilename {
            ...
            set {
                if (this.movieFilename != value) {
                    ...
                    this.Movie = Helper.getThumbnailFromMediaFile(value, 3f);
                }
            }
        }
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        private int contentXShift = -2;
        public int ContentXShift {
            get { return this.contentXShift; }
            set {
                if (this.contentXShift != value) {
                    this.contentXShift = value;
                    this.on_PropertyChanged();
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TwoFlipsMovieScore'", typeIdentifier);
        }
        ...
        public override void Pose(
            ...
            this.TimeoutDuration = VentuzScenes.GamePool._Modules.Timeout.Duration.TenSeconds;
        ...
        public void Vfullscreen_SetContent() {
            ...
            if (this.SelectedDataset is DatasetContent) movieFilename = this.SelectedDataset.MovieFilename;
            this.Vfullscreen_SetContent(this.fullscreenScene, movieFilename, this.ContentXShift);
        }
        public void Vfullscreen_SetContent(
            Fullscreen scene,
            ...
            if (scene is Fullscreen) {
                ...
                scene.SetXShift(xShift);
            }
        }
        public void Vfullscreen_Start() { if (this.FullscreenSceneStatus == VRemote4.HandlerSi.Scene.States.Available) this.fullscreenScene.Start(); }
        public void Vfullscreen_Next() { if (this.FullscreenSceneStatus == VRemote4.HandlerSi.Scene.States.Available) this.fullscreenScene.Next(); }
        public void Vfullscreen_Resolve() { 
            if (this.FullscreenSceneStatus == VRemote4.HandlerSi.Scene.States.Available) this.fullscreenScene.Resolve();
        ...
        public void Vfullscreen_SetResolved() { if (this.FullscreenSceneStatus == VRemote4.HandlerSi.Scene.States.Available) this.fullscreenScene.SetResolvedIn(); }
        ...
        public void Vhost_Set() {
            if (this.HostSceneStatus == VRemote4.HandlerSi.Scene.States.Available &&
                this.SelectedDataset is DatasetContent) {
                this.Vhost_Set(this.hostScene, this.TaskCounter, this.SelectedDataset.HostText);
            }
        }
        public void Vhost_Set(
            Host scene,
