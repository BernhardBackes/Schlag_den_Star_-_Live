...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.MovieSolutionScore {
    ...
    public class DatasetContent : Messaging.Message, INotifyPropertyChanged {
        ...
        public string Name {
            ...
            set {
                if (this.name != value) {
                    ...
                    if (string.IsNullOrEmpty(this.LeftName)) this.LeftName = value;
                    if (string.IsNullOrEmpty(this.RightName)) this.RightName = value;
                }
            }
        }
        ...
        private string leftName = string.Empty;
        public string LeftName {
            get { return this.leftName; }
            set {
                if (this.leftName != value) {
                    if (value == null) value = string.Empty;
                    this.leftName = value;
                    this.on_PropertyChanged();
                }
        ...
        private string rightName = string.Empty;
        public string RightName {
            get { return this.rightName; }
            set {
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.MovieSolutionScore'", typeIdentifier);
        }
        ...
        public void Vfullscreen_TextInsertIn() {
            this.Vfullscreen_SetTextInsert();
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene) this.fullscreenScene.InsertToIn();
        }
        public void Vfullscreen_SetTextInsert() {
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene && this.SelectedDataset is DatasetContent) {
                this.Vfullscreen_SetTextInsert(
        ...
        public void Vfullscreen_SetTextInsert(
            ...
            if (scene is Fullscreen) {
                scene.SetInsertPositionX(this.TextInsertPositionX);
                scene.SetInsertPositionY(this.TextInsertPositionY);
                scene.SetInsertLeftName(leftName);
                scene.SetInsertTime(time);
                scene.SetInsertRightName(rightName);
            }
        }
        public void Vfullscreen_TextInsertOut() {
            if (this.fullscreenScene is VRemote4.HandlerSi.Scene) this.fullscreenScene.InsertToOut();
        }
        ...
        public void Vhost_Set(
            ...
            else if (counter > 0) hostText = string.Format("{0}: {1}", counter.ToString(), hostText);
