...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.MovieSolutionScore {
    ...
    public partial class UserControlGame : _Base.BuzzerScore.UserControlGame {
        ...
        private void buttonVfullscreen_TextIn_Click(object sender, EventArgs e) { this.business.Vfullscreen_TextInsertIn(); }
        private void buttonVfullscreen_TextOut_Click(object sender, EventArgs e) { this.business.Vfullscreen_TextInsertOut(); }
