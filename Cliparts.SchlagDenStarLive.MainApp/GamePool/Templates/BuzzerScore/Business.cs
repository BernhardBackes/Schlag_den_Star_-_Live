...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.BuzzerScore;

namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.BuzzerScore {
    ...
    public class Business : _Base.BuzzerScore.Business {
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.BuzzerScore'", typeIdentifier);
        }
