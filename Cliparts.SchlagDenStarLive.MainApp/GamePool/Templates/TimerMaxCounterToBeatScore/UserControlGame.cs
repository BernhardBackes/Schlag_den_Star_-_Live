...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerMaxCounterToBeatScore
{
    ...
    public partial class UserControlGame : _Base.TimerScore.UserControlGame {
        ...
        public void Pose(
            ...
            bind = new Binding("Text", this.business, "DecisionValue");
            bind.Format += (s, e) => { e.Value = e.Value.ToString(); };
            this.labelDecisionValue.DataBindings.Add(bind);
            ...
            bind = new Binding("Text", this.business, "ToBeatDecisionValue");
            bind.Format += (s, e) => { e.Value = e.Value.ToString(); };
            this.labelToBeatDecisionValue.DataBindings.Add(bind);
            ...
            this.radioButtonFirstPlayer.DataBindings.Add(bind);

            bind = new Binding("Checked", this.business, "SecondPlayer");
            bind.Format += (s, e) => { e.Value = Convert.ToBoolean(e.Value); };
            this.radioButtonSecondPlayer.DataBindings.Add(bind);
        ...
        protected override void Dispose(bool disposing) {
            ...
            this.labelDecisionValue.DataBindings.Clear();
            this.labelCounterTime.DataBindings.Clear();
            this.numericUpDownToBeatValue.DataBindings.Clear();
            this.labelToBeatDecisionValue.DataBindings.Clear();
            this.labelToBeatTime.DataBindings.Clear();
            this.radioButtonFirstPlayer.DataBindings.Clear();
            this.radioButtonSecondPlayer.DataBindings.Clear();
        }
        ...
        protected int secondPlayer(
            int stepIndex) {
            if (this.business.SecondPlayer) return stepIndex + 2;
        ...
        private void buttonResetCounterHot_Click(object sender, EventArgs e) { this.business.ResetCounterHot(); }
        ...
        private void radioButtonFirstPlayer_CheckedChanged(object sender, EventArgs e) { if (this.business is Business && radioButtonFirstPlayer.Checked) this.business.SecondPlayer = false; }
        private void radioButtonSecondPlayer_CheckedChanged(object sender, EventArgs e) { if (this.business is Business && radioButtonSecondPlayer.Checked) this.business.SecondPlayer = true; }
