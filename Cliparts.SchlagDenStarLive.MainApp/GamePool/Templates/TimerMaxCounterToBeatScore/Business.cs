...
using Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TimerMaxCounterToBeatScore;
...
namespace Cliparts.SchlagDenStarLive.MainApp.GamePool.Templates.TimerMaxCounterToBeatScore
{
    ...
    public class Business : _Base.TimerScore.Business {
        ...
        private int toBeatDecisionValue = 0;
        public int ToBeatDecisionValue
        {
            get { return this.toBeatDecisionValue; }
            set
            {
                if (this.toBeatDecisionValue != value)
                {
                    this.toBeatDecisionValue = value;
                    this.on_PropertyChanged();
                }
            }
        }
        ...
        public Business(
            ...
            this.ClassInfo = string.Format("'{0}' of 'Templates.TimerMaxCounterToBeatScore'", typeIdentifier);
        }
        ...
        internal void ResetCounterHot()
        {
            if (this.SecondPlayer)
            {
                if (this.ToBeatValue < this.CounterValue)
                {
                    this.Vinsert_StopTimer();
                }
                else if (this.DecisionValue < this.CounterValue)
                {
                    this.DecisionValue = this.CounterValue;
            ...
            else
            {
                if (this.ToBeatValue < this.CounterValue)
                {
                    this.DecisionValue = this.ToBeatValue;
                    this.ToBeatDecisionValue = this.DecisionValue;
