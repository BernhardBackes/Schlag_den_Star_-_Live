...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.WheelOfFortuneNumericInput {
    ...
    public class Fullscreen : _Base {
        ...
        private const string sceneID = "project/gamepool/wheeloffortunenumericinput/fullscreen";
