...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool._Modules {
    ...
    public class TimeToBeatList : _InsertBase {
        ...
        //	[Path]=.Timer.OnLAP
        //	[Path]=.Timer.Invalid
        //	[Path]=.TimeList.SetOut
        //	[Path]=.TimeList.ToOut
        //	[Path]=.TimeList.TimeToBeat
        //	[Path]=.TimeList.ListItem_00.StopwatchValue
        //	[Path]=.TimeList.ListItem_00.SetIn
        //	[Path]=.TimeList.ListItem_00.ToItem
        //  ...
        //	[Path]=.TimeList.ListItem_10.ToItem
        //	[Path]=.Offset.Value
        //	[Path]=.Offset.Reset
        //	[Path]=.Offset.Show
        //	[Path]=.Counter
        ...
        public enum Styles { Stopwatch, StopwatchName, StopwatchNameCounter1, StopwatchNameCounter2 }
        ...
        public void SetTimeToBeat(float value) { this.SetDataItemValue(".TimeList.TimeToBeat", value); }
        public void SetTimeListOut() { this.SetDataItemTrigger(".TimeList.SetOut"); }
        public void TimeListToOut() { this.SetDataItemTrigger(".TimeList.ToOut"); }
        public void SetTimeListValue(int index, float value) { this.SetDataItemValue(string.Format(".TimeList.ListItem_{0}.StopwatchValue", index.ToString("00")), value); }
        public void SetTimeListItemIn(int index) { this.SetDataItemTrigger(string.Format(".TimeList.ListItem_{0}.SetIn", index.ToString("00"))); }
        public void TimeListToItem(int index) { this.SetDataItemTrigger(string.Format(".TimeList.ListItem_{0}.ToItem", index.ToString("00"))); }
