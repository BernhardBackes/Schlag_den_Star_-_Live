...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.MovieNumericInputCloserToValue {
    ...
    public class Preview : _PreviewBase {
        ...
        [Type]= Ventuz.Remoting4.SceneModel.Enum (type of the current instance)
            ...
            [Elements]= Insert,Host,Player,Fullscreen (an array of strings containing the choice of enum values)
        ...
        public enum Sources { Insert, Host, Player, Fullscreen };

        #region Properties

        private const string sceneID = "project/gamepool/movienumericinputclosertovalue/preview";
