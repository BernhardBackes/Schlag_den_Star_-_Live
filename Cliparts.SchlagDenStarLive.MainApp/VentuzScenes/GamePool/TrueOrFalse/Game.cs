...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TrueOrFalse {
    ...
    public enum SolutionStates { True, False }
    public enum SelectionStates { NotAvailable, True, False }
    ...
    public class Game : _Modules._InsertBase {
        ...
        private const string sceneID = "project/gamepool/trueorfalse/game";
