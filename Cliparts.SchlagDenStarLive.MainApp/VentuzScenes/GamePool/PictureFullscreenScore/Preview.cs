...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.PictureFullscreenScore {
    ...
    public class Preview : _PreviewBase {
        ...
        private const string sceneID = "project/gamepool/picturefullscreenscore/preview";
        ...
        private void init() {
            this.Insert = new Insert(this.syncContext, this.addPort("InsertPort"), Modes.Static);
            this.Fullscreen = new Fullscreen(this.syncContext, this.addPort("FullscreenPort"), Modes.Static);
        }
