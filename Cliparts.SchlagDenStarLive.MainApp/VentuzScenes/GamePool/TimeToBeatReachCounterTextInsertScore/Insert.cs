...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TimeToBeatReachCounterTextInsertScore {

    public class Insert : _Base {

        #region Properties

        private const string sceneID = "project/gamepool/timetobeatreachcountertextinsertscore/insert";
        ...
        public void PlaySound_True() { this.SetDataItemTrigger(".PlaySound.True"); }
        public void PlaySound_False() { this.SetDataItemTrigger(".PlaySound.False"); }
