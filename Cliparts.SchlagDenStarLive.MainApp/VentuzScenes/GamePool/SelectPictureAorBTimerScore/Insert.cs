...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.SelectPictureAorBTimerScore {
    ...
    public class Insert : _Base {
        ...
        private const string sceneID = "project/gamepool/selectpictureaorbtimerscore/insert";
        ...
        public void PlaySoundBuzzerLeft() { this.SetDataItemTrigger(".PlaySound.BuzzerLeft"); }
        public void PlaySoundBuzzerRight() { this.SetDataItemTrigger(".PlaySound.BuzzerRight"); }
