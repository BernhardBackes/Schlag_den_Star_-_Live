...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.SelectPictureAorBTimerScore {
    ...
    public class Preview : _PreviewBase {
        ...
        [Type]= Ventuz.Remoting4.SceneModel.Enum (type of the current instance)
            ...
            [Elements]= Insert,Fullscreen,Host,Player (an array of strings containing the choice of enum values)
        ...
        public enum Sources { Insert, Fullscreen, Host, Player };

        #region Properties

        private const string sceneID = "project/gamepool/selectpictureaorbtimerscore/preview";
