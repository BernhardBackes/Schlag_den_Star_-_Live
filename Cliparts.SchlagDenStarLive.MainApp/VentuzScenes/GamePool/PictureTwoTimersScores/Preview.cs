...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.PictureTwoTimersScores {
    ...
    public class Preview : _PreviewBase {
        ...
        private const string sceneID = "project/gamepool/picturetwotimersscores/preview";
