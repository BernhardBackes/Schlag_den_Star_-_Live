...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TimeToBeatTextInsertScore {

    public class Insert : _Base {

        #region Properties

        private const string sceneID = "project/gamepool/timetobeattextinsertscore/insert";
