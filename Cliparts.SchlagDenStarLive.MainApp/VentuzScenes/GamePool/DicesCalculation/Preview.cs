...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.DicesCalculation {
    ...
    public class Preview : _PreviewBase {
        ...
        [Type]= Ventuz.Remoting4.SceneModel.Enum (type of the current instance)
            ...
            [Elements]= Insert, Tablet (an array of strings containing the choice of enum values)
        ...
        public enum Sources { Insert, Tablet };

        #region Properties

        private const string sceneID = "project/gamepool/dicescalculation/preview";
