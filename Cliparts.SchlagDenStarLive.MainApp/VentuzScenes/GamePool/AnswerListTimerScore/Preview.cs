...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.AnswerListTimerScore {
    ...
    public class Preview : _PreviewBase {
        ...
        [Type]= Ventuz.Remoting4.SceneModel.Enum (type of the current instance)
            ...
            [Elements]= Insert,Stage (an array of strings containing the choice of enum values)
        ...
        private const string sceneID = "project/gamepool/answerlisttimerscore/preview";
