...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TextInsertTeamInputListScore
{
    ...
    public class Insert : _Base {
        ...
        //	[Path]=.InputLeft.ToIn
        //	[Path]=.InputLeft.TextTop        
        //	[Path]=.InputLeft.TextBottom
        ...
        //	[Path]=.InputRight.TextTop
        //	[Path]=.InputRight.TextBottom
        //	[Path]=.InputRight.Status

        #region Properties

        private const string sceneID = "project/gamepool/textinsertteaminputlistscore/insert";
        ...
        public void SetInputLeftTextTop(string value) { this.SetDataItemValue(".InputLeft.TextTop", value); }
        public void SetInputLeftTextBottom(string value) { this.SetDataItemValue(".InputLeft.TextBottom", value); }
        ...
        public void SetInputRightTextTop(string value) { this.SetDataItemValue(".InputRight.TextTop", value); }
        public void SetInputRightTextBottom(string value) { this.SetDataItemValue(".InputRight.TextBottom", value); }
