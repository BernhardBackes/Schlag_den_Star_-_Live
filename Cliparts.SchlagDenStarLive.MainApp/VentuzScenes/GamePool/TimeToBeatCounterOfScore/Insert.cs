...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TimeToBeatCounterOfScore
{
    ...
    public class Insert : _Base {
        ...
        private const string sceneID = "project/gamepool/timetobeatcounterofscore/insert";
