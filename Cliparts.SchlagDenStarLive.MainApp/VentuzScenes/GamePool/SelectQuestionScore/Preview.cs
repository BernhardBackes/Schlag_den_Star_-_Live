...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.SelectQuestionScore {
    ...
    public class Preview : _PreviewBase {
        ...
        [Type]= Ventuz.Remoting4.SceneModel.Enum (type of the current instance)
            ...
            [Elements]= Insert,Host (an array of strings containing the choice of enum values)
        ...
        private const string sceneID = "project/gamepool/selectquestionscore/preview";
        ...
        private void init() {
            ...
            this.Host = new Stage(this.syncContext, this.addPort("HostLayer"), Modes.Static);
        }
