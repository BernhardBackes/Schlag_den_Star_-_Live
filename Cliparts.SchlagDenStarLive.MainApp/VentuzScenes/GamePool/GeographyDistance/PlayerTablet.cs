...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.GeographyDistance {
    ...
    public class PlayerTablet : VRemote4.HandlerSi.Scene, INotifyPropertyChanged
    {
        ...
        private const string sceneID = "project/gamepool/geographydistance/playertablet";
        ...
        public void SelectPlayer(Stage.PlayerSelection value) { this.SetDataItemValue(".Map.SelectedPlayer", value); }
        ...
        public void ShowOffsets() { this.SetDataItemTrigger(".Map.Solution.ShowOffsets"); }
        ...
        public void HideBluePin1() { this.SetDataItemTrigger(".Map.Results.Blue.Pin1.HidePin"); }
        public void ShowBluePin1() { this.SetDataItemTrigger(".Map.Results.Blue.Pin1.ShowPin"); }
        public void HideBluePin2() { this.SetDataItemTrigger(".Map.Results.Blue.Pin2.HidePin"); }
        public void ShowBluePin2() { this.SetDataItemTrigger(".Map.Results.Blue.Pin2.ShowPin"); }
        ...
        public void HideRedPin1() { this.SetDataItemTrigger(".Map.Results.Red.Pin1.HidePin"); }
        public void ShowRedPin1() { this.SetDataItemTrigger(".Map.Results.Red.Pin1.ShowPin"); }
        public void HideRedPin2() { this.SetDataItemTrigger(".Map.Results.Red.Pin2.HidePin"); }
        public void ShowRedPin2() { this.SetDataItemTrigger(".Map.Results.Red.Pin2.ShowPin"); }
