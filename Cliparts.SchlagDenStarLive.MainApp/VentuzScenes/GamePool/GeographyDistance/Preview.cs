...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.GeographyDistance {
    ...
    public class Preview : _PreviewBase {
        ...
        [Type]= Ventuz.Remoting4.SceneModel.Enum (type of the current instance)
            ...
            [Elements]= Insert,Fullscreen,Stage (an array of strings containing the choice of enum values)
        ...
        public enum Sources { Insert, Fullscreen, Stage };

        #region Properties

        private const string sceneID = "project/gamepool/geographydistance/preview";
        ...
        private void init() {
            ...
            this.Stage = new Stage(syncContext, this.addPort("StageLayer"), Modes.Static);
        }
