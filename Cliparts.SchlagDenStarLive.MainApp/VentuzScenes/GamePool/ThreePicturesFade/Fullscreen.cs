...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.ThreePicturesFade {
    ...
    public class Fullscreen : _Base {
        ...
        private const string sceneID = "project/gamepool/threepicturesfade/fullscreen";
        ...
        public void SetSelectionFilename(string value) { this.SetDataItemValue(".Selection.Filename", value); }
        ...
        public void SelectionToIn() { this.SetDataItemTrigger(".Selection.Fader.Show"); }
