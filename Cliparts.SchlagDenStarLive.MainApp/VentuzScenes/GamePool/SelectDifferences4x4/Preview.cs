...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.SelectDifferences4x4 {
    ...
    public class Preview : _PreviewBase {
        ...
        [Type]= Ventuz.Remoting4.SceneModel.Enum (type of the current instance)
            ...
            [Elements]= Insert,Fullscreen,Player (an array of strings containing the choice of enum values)
        ...
        public enum Sources { Insert, Fullscreen, Player };

        #region Properties

        private const string sceneID = "project/gamepool/selectdifferences4x4/preview";
