...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.SortItemsScore {
    ...
    public class Preview : _PreviewBase {
        ...
        [Type]= Ventuz.Remoting4.SceneModel.Enum (type of the current instance)
            ...
            [Elements]= Insert,Player (an array of strings containing the choice of enum values)
            [PropertyType]= System.String (the underlaying system type of this DataItem)
         */
        //	[Path]=.ShowSafeArea

        public enum Sources { Insert, Player };

        #region Properties

        private const string sceneID = "project/gamepool/sortitemsscore/preview";
