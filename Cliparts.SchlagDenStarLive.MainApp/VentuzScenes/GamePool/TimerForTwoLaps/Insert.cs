...
namespace Cliparts.SchlagDenStarLive.MainApp.VentuzScenes.GamePool.TimerForTwoLaps {
    ...
    public class Insert : _Base {
        ...
        public enum Styles { ThreeDots, FourDots, FiveDots }

        #region Properties

        private const string sceneID = "project/gamepool/timerfortwolaps/insert";
        ...
        public void SetTopLap(int value) { this.SetDataItemValue(".Top.Lap", value); }
        ...
        public void SetBottomLap(int value) { this.SetDataItemValue(".Bottom.Lap", value); }
